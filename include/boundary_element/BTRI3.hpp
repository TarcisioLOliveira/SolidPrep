...
class BTRI3 : public BoundaryMeshElement{
    ...
    virtual math::Vector get_force_vector(const math::Matrix& D, const std::vector<double>& u, const gp_Pnt& center, const math::Matrix& rot, const bool transpose = false) const override;
    ...
    inline math::Matrix get_eps(const gp_Pnt& p, const gp_Pnt& center) const{
        ...
        return math::Matrix(
            {b[0], 0, 0, b[1], 0, 0, b[2], 0, 0, 0, 0, 0, 0, 0, 0,
             ...
             c[0], b[0], 0, c[1], b[1], 0, c[2], b[2], 0, 0, 0, 0, 0, 0, 0,
