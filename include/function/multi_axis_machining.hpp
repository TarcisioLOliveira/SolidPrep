...
#ifndef FUNCTION_MULTI_AXIS_MACHINING_HPP
#define FUNCTION_MULTI_AXIS_MACHINING_HPP
...
class MultiAxisMachining : public DensityBasedFunction{
    public:
    MultiAxisMachining(const Meshing* const mesh, const DensityFilter* const filter, gp_Pnt center, gp_Dir axis, double v_norm, double L, double beta);

    virtual ~MultiAxisMachining() = default;
    ...
    std::vector<double> shadows_grad;
