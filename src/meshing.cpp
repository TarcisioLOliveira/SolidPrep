...
void Meshing::generate_elements(const std::vector<size_t>& geom_elem_mapping, 
    ...
    if(this->proj_data->mesh_file != nullptr && this->proj_data->do_meshing){
