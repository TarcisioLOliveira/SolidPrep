...
LinearElasticIsotropic::LinearElasticIsotropic(const std::string& name, double E, double nu, double Smax, double Tmax, bool plane_stress):
    Material(name, {Smax}, {Tmax}), E(E), nu(nu){
