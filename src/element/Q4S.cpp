...
std::vector<double> Q4S::get_Rf(const std::vector<double>& S, const std::vector<double>& F, const double t, const std::vector<gp_Pnt>& points) const{
    const gp_Pnt p0 = this->normalize(points[0]);
    const gp_Pnt p1 = this->normalize(points[1]);
    ...
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(4*F[0]*x[0]*y[0] + 2*F[0]*x[0]*y[1] + 2*F[0]*x[1]*y[0] + 4*F[0]*x[1]*y[1] + 3*S[0]*x[0]*x[0]*y[0] + S[0]*x[0]*x[0]*y[1] + 2*S[0]*x[0]*x[1]*y[0] + 2*S[0]*x[0]*x[1]*y[1] + S[0]*x[1]*x[1]*y[0] + 3*S[0]*x[1]*x[1]*y[1] + 3*S[1]*x[0]*y[0]*y[0] + 2*S[1]*x[0]*y[0]*y[1] + S[1]*x[0]*y[1]*y[1] + S[1]*x[1]*y[0]*y[0] + 2*S[1]*x[1]*y[0]*y[1] + 3*S[1]*x[1]*y[1]*y[1] + 6*a*b*(2*F[0] + S[0]*x[0] + S[0]*x[1] + S[1]*y[0] + S[1]*y[1]) - 2*a*(3*F[0]*y[0] + 3*F[0]*y[1] + 2*S[0]*x[0]*y[0] + S[0]*x[0]*y[1] + S[0]*x[1]*y[0] + 2*S[0]*x[1]*y[1] + 2*S[1]*y[0]*y[0] + 2*S[1]*y[0]*y[1] + 2*S[1]*y[1]*y[1]) - 2*b*(3*F[0]*x[0] + 3*F[0]*x[1] + 2*S[0]*x[0]*x[0] + 2*S[0]*x[0]*x[1] + 2*S[0]*x[1]*x[1] + 2*S[1]*x[0]*y[0] + S[1]*x[0]*y[1] + S[1]*x[1]*y[0] + 2*S[1]*x[1]*y[1]))/(48*a*b)
    ,
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(4*F[1]*x[0]*y[0] + 2*F[1]*x[0]*y[1] + 2*F[1]*x[1]*y[0] + 4*F[1]*x[1]*y[1] + 3*S[2]*x[0]*x[0]*y[0] + S[2]*x[0]*x[0]*y[1] + 2*S[2]*x[0]*x[1]*y[0] + 2*S[2]*x[0]*x[1]*y[1] + S[2]*x[1]*x[1]*y[0] + 3*S[2]*x[1]*x[1]*y[1] + 3*S[3]*x[0]*y[0]*y[0] + 2*S[3]*x[0]*y[0]*y[1] + S[3]*x[0]*y[1]*y[1] + S[3]*x[1]*y[0]*y[0] + 2*S[3]*x[1]*y[0]*y[1] + 3*S[3]*x[1]*y[1]*y[1] + 6*a*b*(2*F[1] + S[2]*x[0] + S[2]*x[1] + S[3]*y[0] + S[3]*y[1]) - 2*a*(3*F[1]*y[0] + 3*F[1]*y[1] + 2*S[2]*x[0]*y[0] + S[2]*x[0]*y[1] + S[2]*x[1]*y[0] + 2*S[2]*x[1]*y[1] + 2*S[3]*y[0]*y[0] + 2*S[3]*y[0]*y[1] + 2*S[3]*y[1]*y[1]) - 2*b*(3*F[1]*x[0] + 3*F[1]*x[1] + 2*S[2]*x[0]*x[0] + 2*S[2]*x[0]*x[1] + 2*S[2]*x[1]*x[1] + 2*S[3]*x[0]*y[0] + S[3]*x[0]*y[1] + S[3]*x[1]*y[0] + 2*S[3]*x[1]*y[1]))/(48*a*b)
    ,
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(-4*F[0]*x[0]*y[0] - 2*F[0]*x[0]*y[1] - 2*F[0]*x[1]*y[0] - 4*F[0]*x[1]*y[1] - 3*S[0]*x[0]*x[0]*y[0] - S[0]*x[0]*x[0]*y[1] - 2*S[0]*x[0]*x[1]*y[0] - 2*S[0]*x[0]*x[1]*y[1] - S[0]*x[1]*x[1]*y[0] - 3*S[0]*x[1]*x[1]*y[1] - 3*S[1]*x[0]*y[0]*y[0] - 2*S[1]*x[0]*y[0]*y[1] - S[1]*x[0]*y[1]*y[1] - S[1]*x[1]*y[0]*y[0] - 2*S[1]*x[1]*y[0]*y[1] - 3*S[1]*x[1]*y[1]*y[1] + 6*a*b*(2*F[0] + S[0]*x[0] +S[0]*x[1] + S[1]*y[0] + S[1]*y[1]) - 2*a*(3*F[0]*y[0] + 3*F[0]*y[1] + 2*S[0]*x[0]*y[0] + S[0]*x[0]*y[1] + S[0]*x[1]*y[0] + 2*S[0]*x[1]*y[1] + 2*S[1]*y[0]*y[0] + 2*S[1]*y[0]*y[1] + 2*S[1]*y[1]*y[1]) + 2*b*(3*F[0]*x[0] + 3*F[0]*x[1] + 2*S[0]*x[0]*x[0] + 2*S[0]*x[0]*x[1] + 2*S[0]*x[1]*x[1] + 2*S[1]*x[0]*y[0] + S[1]*x[0]*y[1] + S[1]*x[1]*y[0] + 2*S[1]*x[1]*y[1]))/(48*a*b)
    ,
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(-4*F[1]*x[0]*y[0] - 2*F[1]*x[0]*y[1] - 2*F[1]*x[1]*y[0] - 4*F[1]*x[1]*y[1] - 3*S[2]*x[0]*x[0]*y[0] - S[2]*x[0]*x[0]*y[1] - 2*S[2]*x[0]*x[1]*y[0] - 2*S[2]*x[0]*x[1]*y[1] - S[2]*x[1]*x[1]*y[0] - 3*S[2]*x[1]*x[1]*y[1] - 3*S[3]*x[0]*y[0]*y[0] - 2*S[3]*x[0]*y[0]*y[1] - S[3]*x[0]*y[1]*y[1] - S[3]*x[1]*y[0]*y[0] - 2*S[3]*x[1]*y[0]*y[1] - 3*S[3]*x[1]*y[1]*y[1] + 6*a*b*(2*F[1] + S[2]*x[0] +S[2]*x[1] + S[3]*y[0] + S[3]*y[1]) - 2*a*(3*F[1]*y[0] + 3*F[1]*y[1] + 2*S[2]*x[0]*y[0] + S[2]*x[0]*y[1] + S[2]*x[1]*y[0] + 2*S[2]*x[1]*y[1] + 2*S[3]*y[0]*y[0] + 2*S[3]*y[0]*y[1] + 2*S[3]*y[1]*y[1]) + 2*b*(3*F[1]*x[0] + 3*F[1]*x[1] + 2*S[2]*x[0]*x[0] + 2*S[2]*x[0]*x[1] + 2*S[2]*x[1]*x[1] + 2*S[3]*x[0]*y[0] + S[3]*x[0]*y[1] + S[3]*x[1]*y[0] + 2*S[3]*x[1]*y[1]))/(48*a*b)
