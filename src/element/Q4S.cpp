...
std::vector<double> Q4S::get_Rf(const std::vector<double>& S, const double t, const std::vector<gp_Pnt>& points) const{
    const gp_Pnt p0 = this->normalize(points[0]);
    const gp_Pnt p1 = this->normalize(points[1]);
