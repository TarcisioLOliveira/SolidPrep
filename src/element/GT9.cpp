...
std::vector<double> GT9::get_Rf(const std::vector<double>& S, const std::vector<double>& F, const gp_Pnt& C, const double t, const std::vector<gp_Pnt>& points) const{
    const double x[]{points[0].X(), points[1].X()};
    const double y[]{points[0].Y(), points[1].Y()};
    const double cx = C.X();
    const double cy = C.Y();
    ...
    ,
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(12*F[0]*a[0]*a[1]*b[2] - 12*F[0]*a[0]*a[2]*b[1] - 6*F[0]*a[0]*b[1]*c[2]*y[0] - 6*F[0]*a[0]*b[1]*c[2]*y[1] + 6*F[0]*a[0]*b[2]*c[1]*y[0] + 6*F[0]*a[0]*b[2]*c[1]*y[1] + 6*F[0]*a[1]*b[0]*b[2]*x[0] + 6*F[0]*a[1]*b[0]*b[2]*x[1] + 6*F[0]*a[1]*b[2]*c[0]*y[0] + 6*F[0]*a[1]*b[2]*c[0]*y[1] - 6*F[0]*a[2]*b[0]*b[1]*x[0] - 6*F[0]*a[2]*b[0]*b[1]*x[1] - 6*F[0]*a[2]*b[1]*c[0]*y[0] - 6*F[0]*a[2]*b[1]*c[0]*y[1] - 4*F[0]*b[0]*b[1]*c[2]*x[0]*y[0] - 2*F[0]*b[0]*b[1]*c[2]*x[0]*y[1] - 2*F[0]*b[0]*b[1]*c[2]*x[1]*y[0] - 4*F[0]*b[0]*b[1]*c[2]*x[1]*y[1] + 4*F[0]*b[0]*b[2]*c[1]*x[0]*y[0] + 2*F[0]*b[0]*b[2]*c[1]*x[0]*y[1] + 2*F[0]*b[0]*b[2]*c[1]*x[1]*y[0] + 4*F[0]*b[0]*b[2]*c[1]*x[1]*y[1] - 4*F[0]*b[1]*c[0]*c[2]*y[0]*y[0] - 4*F[0]*b[1]*c[0]*c[2]*y[0]*y[1] - 4*F[0]*b[1]*c[0]*c[2]*y[1]*y[1] + 4*F[0]*b[2]*c[0]*c[1]*y[0]*y[0] + 4*F[0]*b[2]*c[0]*c[1]*y[0]*y[1] + 4*F[0]*b[2]*c[0]*c[1]*y[1]*y[1] + 12*F[1]*a[0]*a[1]*c[2] - 12*F[1]*a[0]*a[2]*c[1] + 6*F[1]*a[0]*b[1]*c[2]*x[0] + 6*F[1]*a[0]*b[1]*c[2]*x[1] - 6*F[1]*a[0]*b[2]*c[1]*x[0] - 6*F[1]*a[0]*b[2]*c[1]*x[1] + 6*F[1]*a[1]*b[0]*c[2]*x[0] + 6*F[1]*a[1]*b[0]*c[2]*x[1] + 6*F[1]*a[1]*c[0]*c[2]*y[0] + 6*F[1]*a[1]*c[0]*c[2]*y[1] - 6*F[1]*a[2]*b[0]*c[1]*x[0] - 6*F[1]*a[2]*b[0]*c[1]*x[1] - 6*F[1]*a[2]*c[0]*c[1]*y[0] - 6*F[1]*a[2]*c[0]*c[1]*y[1] + 4*F[1]*b[0]*b[1]*c[2]*x[0]*x[0] + 4*F[1]*b[0]*b[1]*c[2]*x[0]*x[1] + 4*F[1]*b[0]*b[1]*c[2]*x[1]*x[1] - 4*F[1]*b[0]*b[2]*c[1]*x[0]*x[0] - 4*F[1]*b[0]*b[2]*c[1]*x[0]*x[1] - 4*F[1]*b[0]*b[2]*c[1]*x[1]*x[1] + 4*F[1]*b[1]*c[0]*c[2]*x[0]*y[0] + 2*F[1]*b[1]*c[0]*c[2]*x[0]*y[1] + 2*F[1]*b[1]*c[0]*c[2]*x[1]*y[0] + 4*F[1]*b[1]*c[0]*c[2]*x[1]*y[1] - 4*F[1]*b[2]*c[0]*c[1]*x[0]*y[0] - 2*F[1]*b[2]*c[0]*c[1]*x[0]*y[1] - 2*F[1]*b[2]*c[0]*c[1]*x[1]*y[0] - 4*F[1]*b[2]*c[0]*c[1]*x[1]*y[1] - 12*S[0]*a[0]*a[1]*b[2]*cx + 6*S[0]*a[0]*a[1]*b[2]*x[0] + 6*S[0]*a[0]*a[1]*b[2]*x[1] + 12*S[0]*a[0]*a[2]*b[1]*cx - 6*S[0]*a[0]*a[2]*b[1]*x[0] - 6*S[0]*a[0]*a[2]*b[1]*x[1] + 6*S[0]*a[0]*b[1]*c[2]*cx*y[0] + 6*S[0]*a[0]*b[1]*c[2]*cx*y[1] - 4*S[0]*a[0]*b[1]*c[2]*x[0]*y[0] - 2*S[0]*a[0]*b[1]*c[2]*x[0]*y[1] - 2*S[0]*a[0]*b[1]*c[2]*x[1]*y[0] - 4*S[0]*a[0]*b[1]*c[2]*x[1]*y[1] - 6*S[0]*a[0]*b[2]*c[1]*cx*y[0] - 6*S[0]*a[0]*b[2]*c[1]*cx*y[1] + 4*S[0]*a[0]*b[2]*c[1]*x[0]*y[0] + 2*S[0]*a[0]*b[2]*c[1]*x[0]*y[1] + 2*S[0]*a[0]*b[2]*c[1]*x[1]*y[0] + 4*S[0]*a[0]*b[2]*c[1]*x[1]*y[1] - 6*S[0]*a[1]*b[0]*b[2]*cx*x[0] - 6*S[0]*a[1]*b[0]*b[2]*cx*x[1] + 4*S[0]*a[1]*b[0]*b[2]*x[0]*x[0] + 4*S[0]*a[1]*b[0]*b[2]*x[0]*x[1] + 4*S[0]*a[1]*b[0]*b[2]*x[1]*x[1] - 6*S[0]*a[1]*b[2]*c[0]*cx*y[0] - 6*S[0]*a[1]*b[2]*c[0]*cx*y[1] + 4*S[0]*a[1]*b[2]*c[0]*x[0]*y[0] + 2*S[0]*a[1]*b[2]*c[0]*x[0]*y[1] + 2*S[0]*a[1]*b[2]*c[0]*x[1]*y[0] + 4*S[0]*a[1]*b[2]*c[0]*x[1]*y[1] + 6*S[0]*a[2]*b[0]*b[1]*cx*x[0] + 6*S[0]*a[2]*b[0]*b[1]*cx*x[1] - 4*S[0]*a[2]*b[0]*b[1]*x[0]*x[0] - 4*S[0]*a[2]*b[0]*b[1]*x[0]*x[1] - 4*S[0]*a[2]*b[0]*b[1]*x[1]*x[1] + 6*S[0]*a[2]*b[1]*c[0]*cx*y[0] + 6*S[0]*a[2]*b[1]*c[0]*cx*y[1] - 4*S[0]*a[2]*b[1]*c[0]*x[0]*y[0] - 2*S[0]*a[2]*b[1]*c[0]*x[0]*y[1] - 2*S[0]*a[2]*b[1]*c[0]*x[1]*y[0] - 4*S[0]*a[2]*b[1]*c[0]*x[1]*y[1] + 4*S[0]*b[0]*b[1]*c[2]*cx*x[0]*y[0] + 2*S[0]*b[0]*b[1]*c[2]*cx*x[0]*y[1] + 2*S[0]*b[0]*b[1]*c[2]*cx*x[1]*y[0] + 4*S[0]*b[0]*b[1]*c[2]*cx*x[1]*y[1] - 3*S[0]*b[0]*b[1]*c[2]*x[0]*x[0]*y[0] - S[0]*b[0]*b[1]*c[2]*x[0]*x[0]*y[1] - 2*S[0]*b[0]*b[1]*c[2]*x[0]*x[1]*y[0] - 2*S[0]*b[0]*b[1]*c[2]*x[0]*x[1]*y[1] - S[0]*b[0]*b[1]*c[2]*x[1]*x[1]*y[0] - 3*S[0]*b[0]*b[1]*c[2]*x[1]*x[1]*y[1] - 4*S[0]*b[0]*b[2]*c[1]*cx*x[0]*y[0] - 2*S[0]*b[0]*b[2]*c[1]*cx*x[0]*y[1] - 2*S[0]*b[0]*b[2]*c[1]*cx*x[1]*y[0] - 4*S[0]*b[0]*b[2]*c[1]*cx*x[1]*y[1] + 3*S[0]*b[0]*b[2]*c[1]*x[0]*x[0]*y[0] + S[0]*b[0]*b[2]*c[1]*x[0]*x[0]*y[1] + 2*S[0]*b[0]*b[2]*c[1]*x[0]*x[1]*y[0] + 2*S[0]*b[0]*b[2]*c[1]*x[0]*x[1]*y[1] + S[0]*b[0]*b[2]*c[1]*x[1]*x[1]*y[0] + 3*S[0]*b[0]*b[2]*c[1]*x[1]*x[1]*y[1] + 4*S[0]*b[1]*c[0]*c[2]*cx*y[0]*y[0] + 4*S[0]*b[1]*c[0]*c[2]*cx*y[0]*y[1] + 4*S[0]*b[1]*c[0]*c[2]*cx*y[1]*y[1] - 3*S[0]*b[1]*c[0]*c[2]*x[0]*y[0]*y[0] - 2*S[0]*b[1]*c[0]*c[2]*x[0]*y[0]*y[1] - S[0]*b[1]*c[0]*c[2]*x[0]*y[1]*y[1] - S[0]*b[1]*c[0]*c[2]*x[1]*y[0]*y[0] - 2*S[0]*b[1]*c[0]*c[2]*x[1]*y[0]*y[1] - 3*S[0]*b[1]*c[0]*c[2]*x[1]*y[1]*y[1] - 4*S[0]*b[2]*c[0]*c[1]*cx*y[0]*y[0] - 4*S[0]*b[2]*c[0]*c[1]*cx*y[0]*y[1] - 4*S[0]*b[2]*c[0]*c[1]*cx*y[1]*y[1] + 3*S[0]*b[2]*c[0]*c[1]*x[0]*y[0]*y[0] + 2*S[0]*b[2]*c[0]*c[1]*x[0]*y[0]*y[1] + S[0]*b[2]*c[0]*c[1]*x[0]*y[1]*y[1] + S[0]*b[2]*c[0]*c[1]*x[1]*y[0]*y[0] + 2*S[0]*b[2]*c[0]*c[1]*x[1]*y[0]*y[1] + 3*S[0]*b[2]*c[0]*c[1]*x[1]*y[1]*y[1] - 12*S[1]*a[0]*a[1]*b[2]*cy + 6*S[1]*a[0]*a[1]*b[2]*y[0] + 6*S[1]*a[0]*a[1]*b[2]*y[1] + 12*S[1]*a[0]*a[2]*b[1]*cy - 6*S[1]*a[0]*a[2]*b[1]*y[0] -6*S[1]*a[0]*a[2]*b[1]*y[1] + 6*S[1]*a[0]*b[1]*c[2]*cy*y[0] + 6*S[1]*a[0]*b[1]*c[2]*cy*y[1] - 4*S[1]*a[0]*b[1]*c[2]*y[0]*y[0] - 4*S[1]*a[0]*b[1]*c[2]*y[0]*y[1] - 4*S[1]*a[0]*b[1]*c[2]*y[1]*y[1] - 6*S[1]*a[0]*b[2]*c[1]*cy*y[0] - 6*S[1]*a[0]*b[2]*c[1]*cy*y[1] + 4*S[1]*a[0]*b[2]*c[1]*y[0]*y[0] + 4*S[1]*a[0]*b[2]*c[1]*y[0]*y[1] + 4*S[1]*a[0]*b[2]*c[1]*y[1]*y[1] - 6*S[1]*a[1]*b[0]*b[2]*cy*x[0] - 6*S[1]*a[1]*b[0]*b[2]*cy*x[1] + 4*S[1]*a[1]*b[0]*b[2]*x[0]*y[0] + 2*S[1]*a[1]*b[0]*b[2]*x[0]*y[1] + 2*S[1]*a[1]*b[0]*b[2]*x[1]*y[0] + 4*S[1]*a[1]*b[0]*b[2]*x[1]*y[1] - 6*S[1]*a[1]*b[2]*c[0]*cy*y[0] - 6*S[1]*a[1]*b[2]*c[0]*cy*y[1] + 4*S[1]*a[1]*b[2]*c[0]*y[0]*y[0] + 4*S[1]*a[1]*b[2]*c[0]*y[0]*y[1] + 4*S[1]*a[1]*b[2]*c[0]*y[1]*y[1] + 6*S[1]*a[2]*b[0]*b[1]*cy*x[0] + 6*S[1]*a[2]*b[0]*b[1]*cy*x[1] - 4*S[1]*a[2]*b[0]*b[1]*x[0]*y[0] - 2*S[1]*a[2]*b[0]*b[1]*x[0]*y[1] - 2*S[1]*a[2]*b[0]*b[1]*x[1]*y[0] - 4*S[1]*a[2]*b[0]*b[1]*x[1]*y[1] + 6*S[1]*a[2]*b[1]*c[0]*cy*y[0] + 6*S[1]*a[2]*b[1]*c[0]*cy*y[1] - 4*S[1]*a[2]*b[1]*c[0]*y[0]*y[0] - 4*S[1]*a[2]*b[1]*c[0]*y[0]*y[1] - 4*S[1]*a[2]*b[1]*c[0]*y[1]*y[1] + 4*S[1]*b[0]*b[1]*c[2]*cy*x[0]*y[0] + 2*S[1]*b[0]*b[1]*c[2]*cy*x[0]*y[1] + 2*S[1]*b[0]*b[1]*c[2]*cy*x[1]*y[0] + 4*S[1]*b[0]*b[1]*c[2]*cy*x[1]*y[1] - 3*S[1]*b[0]*b[1]*c[2]*x[0]*y[0]*y[0] - 2*S[1]*b[0]*b[1]*c[2]*x[0]*y[0]*y[1] - S[1]*b[0]*b[1]*c[2]*x[0]*y[1]*y[1] - S[1]*b[0]*b[1]*c[2]*x[1]*y[0]*y[0] - 2*S[1]*b[0]*b[1]*c[2]*x[1]*y[0]*y[1] - 3*S[1]*b[0]*b[1]*c[2]*x[1]*y[1]*y[1] - 4*S[1]*b[0]*b[2]*c[1]*cy*x[0]*y[0] - 2*S[1]*b[0]*b[2]*c[1]*cy*x[0]*y[1] - 2*S[1]*b[0]*b[2]*c[1]*cy*x[1]*y[0] - 4*S[1]*b[0]*b[2]*c[1]*cy*x[1]*y[1] + 3*S[1]*b[0]*b[2]*c[1]*x[0]*y[0]*y[0] + 2*S[1]*b[0]*b[2]*c[1]*x[0]*y[0]*y[1] + S[1]*b[0]*b[2]*c[1]*x[0]*y[1]*y[1] + S[1]*b[0]*b[2]*c[1]*x[1]*y[0]*y[0] + 2*S[1]*b[0]*b[2]*c[1]*x[1]*y[0]*y[1] + 3*S[1]*b[0]*b[2]*c[1]*x[1]*y[1]*y[1] + 4*S[1]*b[1]*c[0]*c[2]*cy*y[0]*y[0] + 4*S[1]*b[1]*c[0]*c[2]*cy*y[0]*y[1] + 4*S[1]*b[1]*c[0]*c[2]*cy*y[1]*y[1] - 3*S[1]*b[1]*c[0]*c[2]*y[0]*y[0]*y[0] - 3*S[1]*b[1]*c[0]*c[2]*y[0]*y[0]*y[1] - 3*S[1]*b[1]*c[0]*c[2]*y[0]*y[1]*y[1] - 3*S[1]*b[1]*c[0]*c[2]*y[1]*y[1]*y[1] - 4*S[1]*b[2]*c[0]*c[1]*cy*y[0]*y[0] - 4*S[1]*b[2]*c[0]*c[1]*cy*y[0]*y[1] - 4*S[1]*b[2]*c[0]*c[1]*cy*y[1]*y[1] + 3*S[1]*b[2]*c[0]*c[1]*y[0]*y[0]*y[0] + 3*S[1]*b[2]*c[0]*c[1]*y[0]*y[0]*y[1] + 3*S[1]*b[2]*c[0]*c[1]*y[0]*y[1]*y[1] + 3*S[1]*b[2]*c[0]*c[1]*y[1]*y[1]*y[1] - 12*S[2]*a[0]*a[1]*c[2]*cx + 6*S[2]*a[0]*a[1]*c[2]*x[0] + 6*S[2]*a[0]*a[1]*c[2]*x[1] + 12*S[2]*a[0]*a[2]*c[1]*cx - 6*S[2]*a[0]*a[2]*c[1]*x[0] - 6*S[2]*a[0]*a[2]*c[1]*x[1] - 6*S[2]*a[0]*b[1]*c[2]*cx*x[0] - 6*S[2]*a[0]*b[1]*c[2]*cx*x[1] + 4*S[2]*a[0]*b[1]*c[2]*x[0]*x[0] + 4*S[2]*a[0]*b[1]*c[2]*x[0]*x[1] + 4*S[2]*a[0]*b[1]*c[2]*x[1]*x[1] + 6*S[2]*a[0]*b[2]*c[1]*cx*x[0] + 6*S[2]*a[0]*b[2]*c[1]*cx*x[1] - 4*S[2]*a[0]*b[2]*c[1]*x[0]*x[0] - 4*S[2]*a[0]*b[2]*c[1]*x[0]*x[1] - 4*S[2]*a[0]*b[2]*c[1]*x[1]*x[1] - 6*S[2]*a[1]*b[0]*c[2]*cx*x[0] - 6*S[2]*a[1]*b[0]*c[2]*cx*x[1] + 4*S[2]*a[1]*b[0]*c[2]*x[0]*x[0] + 4*S[2]*a[1]*b[0]*c[2]*x[0]*x[1] + 4*S[2]*a[1]*b[0]*c[2]*x[1]*x[1] - 6*S[2]*a[1]*c[0]*c[2]*cx*y[0] - 6*S[2]*a[1]*c[0]*c[2]*cx*y[1] + 4*S[2]*a[1]*c[0]*c[2]*x[0]*y[0] + 2*S[2]*a[1]*c[0]*c[2]*x[0]*y[1] + 2*S[2]*a[1]*c[0]*c[2]*x[1]*y[0] + 4*S[2]*a[1]*c[0]*c[2]*x[1]*y[1] + 6*S[2]*a[2]*b[0]*c[1]*cx*x[0] + 6*S[2]*a[2]*b[0]*c[1]*cx*x[1] - 4*S[2]*a[2]*b[0]*c[1]*x[0]*x[0] - 4*S[2]*a[2]*b[0]*c[1]*x[0]*x[1] - 4*S[2]*a[2]*b[0]*c[1]*x[1]*x[1] + 6*S[2]*a[2]*c[0]*c[1]*cx*y[0] + 6*S[2]*a[2]*c[0]*c[1]*cx*y[1] - 4*S[2]*a[2]*c[0]*c[1]*x[0]*y[0] - 2*S[2]*a[2]*c[0]*c[1]*x[0]*y[1] - 2*S[2]*a[2]*c[0]*c[1]*x[1]*y[0] - 4*S[2]*a[2]*c[0]*c[1]*x[1]*y[1] - 4*S[2]*b[0]*b[1]*c[2]*cx*x[0]*x[0] - 4*S[2]*b[0]*b[1]*c[2]*cx*x[0]*x[1] - 4*S[2]*b[0]*b[1]*c[2]*cx*x[1]*x[1] + 3*S[2]*b[0]*b[1]*c[2]*x[0]*x[0]*x[0] + 3*S[2]*b[0]*b[1]*c[2]*x[0]*x[0]*x[1] + 3*S[2]*b[0]*b[1]*c[2]*x[0]*x[1]*x[1] + 3*S[2]*b[0]*b[1]*c[2]*x[1]*x[1]*x[1] + 4*S[2]*b[0]*b[2]*c[1]*cx*x[0]*x[0] + 4*S[2]*b[0]*b[2]*c[1]*cx*x[0]*x[1] + 4*S[2]*b[0]*b[2]*c[1]*cx*x[1]*x[1] - 3*S[2]*b[0]*b[2]*c[1]*x[0]*x[0]*x[0] - 3*S[2]*b[0]*b[2]*c[1]*x[0]*x[0]*x[1] - 3*S[2]*b[0]*b[2]*c[1]*x[0]*x[1]*x[1] - 3*S[2]*b[0]*b[2]*c[1]*x[1]*x[1]*x[1] - 4*S[2]*b[1]*c[0]*c[2]*cx*x[0]*y[0] - 2*S[2]*b[1]*c[0]*c[2]*cx*x[0]*y[1] - 2*S[2]*b[1]*c[0]*c[2]*cx*x[1]*y[0] - 4*S[2]*b[1]*c[0]*c[2]*cx*x[1]*y[1] + 3*S[2]*b[1]*c[0]*c[2]*x[0]*x[0]*y[0] + S[2]*b[1]*c[0]*c[2]*x[0]*x[0]*y[1] + 2*S[2]*b[1]*c[0]*c[2]*x[0]*x[1]*y[0] + 2*S[2]*b[1]*c[0]*c[2]*x[0]*x[1]*y[1] + S[2]*b[1]*c[0]*c[2]*x[1]*x[1]*y[0] + 3*S[2]*b[1]*c[0]*c[2]*x[1]*x[1]*y[1] + 4*S[2]*b[2]*c[0]*c[1]*cx*x[0]*y[0] + 2*S[2]*b[2]*c[0]*c[1]*cx*x[0]*y[1] + 2*S[2]*b[2]*c[0]*c[1]*cx*x[1]*y[0] + 4*S[2]*b[2]*c[0]*c[1]*cx*x[1]*y[1] - 3*S[2]*b[2]*c[0]*c[1]*x[0]*x[0]*y[0] - S[2]*b[2]*c[0]*c[1]*x[0]*x[0]*y[1] - 2*S[2]*b[2]*c[0]*c[1]*x[0]*x[1]*y[0] - 2*S[2]*b[2]*c[0]*c[1]*x[0]*x[1]*y[1] - S[2]*b[2]*c[0]*c[1]*x[1]*x[1]*y[0] - 3*S[2]*b[2]*c[0]*c[1]*x[1]*x[1]*y[1] - 12*S[3]*a[0]*a[1]*c[2]*cy + 6*S[3]*a[0]*a[1]*c[2]*y[0] + 6*S[3]*a[0]*a[1]*c[2]*y[1] + 12*S[3]*a[0]*a[2]*c[1]*cy - 6*S[3]*a[0]*a[2]*c[1]*y[0] - 6*S[3]*a[0]*a[2]*c[1]*y[1] - 6*S[3]*a[0]*b[1]*c[2]*cy*x[0] - 6*S[3]*a[0]*b[1]*c[2]*cy*x[1] + 4*S[3]*a[0]*b[1]*c[2]*x[0]*y[0] + 2*S[3]*a[0]*b[1]*c[2]*x[0]*y[1] + 2*S[3]*a[0]*b[1]*c[2]*x[1]*y[0] + 4*S[3]*a[0]*b[1]*c[2]*x[1]*y[1] + 6*S[3]*a[0]*b[2]*c[1]*cy*x[0] + 6*S[3]*a[0]*b[2]*c[1]*cy*x[1] - 4*S[3]*a[0]*b[2]*c[1]*x[0]*y[0] - 2*S[3]*a[0]*b[2]*c[1]*x[0]*y[1] - 2*S[3]*a[0]*b[2]*c[1]*x[1]*y[0] - 4*S[3]*a[0]*b[2]*c[1]*x[1]*y[1] - 6*S[3]*a[1]*b[0]*c[2]*cy*x[0] - 6*S[3]*a[1]*b[0]*c[2]*cy*x[1] + 4*S[3]*a[1]*b[0]*c[2]*x[0]*y[0] + 2*S[3]*a[1]*b[0]*c[2]*x[0]*y[1] + 2*S[3]*a[1]*b[0]*c[2]*x[1]*y[0] + 4*S[3]*a[1]*b[0]*c[2]*x[1]*y[1] - 6*S[3]*a[1]*c[0]*c[2]*cy*y[0] - 6*S[3]*a[1]*c[0]*c[2]*cy*y[1] + 4*S[3]*a[1]*c[0]*c[2]*y[0]*y[0] + 4*S[3]*a[1]*c[0]*c[2]*y[0]*y[1] + 4*S[3]*a[1]*c[0]*c[2]*y[1]*y[1] + 6*S[3]*a[2]*b[0]*c[1]*cy*x[0] + 6*S[3]*a[2]*b[0]*c[1]*cy*x[1] - 4*S[3]*a[2]*b[0]*c[1]*x[0]*y[0] - 2*S[3]*a[2]*b[0]*c[1]*x[0]*y[1] - 2*S[3]*a[2]*b[0]*c[1]*x[1]*y[0] - 4*S[3]*a[2]*b[0]*c[1]*x[1]*y[1] + 6*S[3]*a[2]*c[0]*c[1]*cy*y[0] + 6*S[3]*a[2]*c[0]*c[1]*cy*y[1] - 4*S[3]*a[2]*c[0]*c[1]*y[0]*y[0] - 4*S[3]*a[2]*c[0]*c[1]*y[0]*y[1] - 4*S[3]*a[2]*c[0]*c[1]*y[1]*y[1] - 4*S[3]*b[0]*b[1]*c[2]*cy*x[0]*x[0] - 4*S[3]*b[0]*b[1]*c[2]*cy*x[0]*x[1] - 4*S[3]*b[0]*b[1]*c[2]*cy*x[1]*x[1] + 3*S[3]*b[0]*b[1]*c[2]*x[0]*x[0]*y[0] + S[3]*b[0]*b[1]*c[2]*x[0]*x[0]*y[1] + 2*S[3]*b[0]*b[1]*c[2]*x[0]*x[1]*y[0] + 2*S[3]*b[0]*b[1]*c[2]*x[0]*x[1]*y[1] + S[3]*b[0]*b[1]*c[2]*x[1]*x[1]*y[0] + 3*S[3]*b[0]*b[1]*c[2]*x[1]*x[1]*y[1] + 4*S[3]*b[0]*b[2]*c[1]*cy*x[0]*x[0] + 4*S[3]*b[0]*b[2]*c[1]*cy*x[0]*x[1] + 4*S[3]*b[0]*b[2]*c[1]*cy*x[1]*x[1] - 3*S[3]*b[0]*b[2]*c[1]*x[0]*x[0]*y[0] - S[3]*b[0]*b[2]*c[1]*x[0]*x[0]*y[1] - 2*S[3]*b[0]*b[2]*c[1]*x[0]*x[1]*y[0] - 2*S[3]*b[0]*b[2]*c[1]*x[0]*x[1]*y[1] - S[3]*b[0]*b[2]*c[1]*x[1]*x[1]*y[0] - 3*S[3]*b[0]*b[2]*c[1]*x[1]*x[1]*y[1] - 4*S[3]*b[1]*c[0]*c[2]*cy*x[0]*y[0] - 2*S[3]*b[1]*c[0]*c[2]*cy*x[0]*y[1] - 2*S[3]*b[1]*c[0]*c[2]*cy*x[1]*y[0] - 4*S[3]*b[1]*c[0]*c[2]*cy*x[1]*y[1] + 3*S[3]*b[1]*c[0]*c[2]*x[0]*y[0]*y[0]+ 2*S[3]*b[1]*c[0]*c[2]*x[0]*y[0]*y[1] + S[3]*b[1]*c[0]*c[2]*x[0]*y[1]*y[1] + S[3]*b[1]*c[0]*c[2]*x[1]*y[0]*y[0] + 2*S[3]*b[1]*c[0]*c[2]*x[1]*y[0]*y[1] + 3*S[3]*b[1]*c[0]*c[2]*x[1]*y[1]*y[1] + 4*S[3]*b[2]*c[0]*c[1]*cy*x[0]*y[0] + 2*S[3]*b[2]*c[0]*c[1]*cy*x[0]*y[1] + 2*S[3]*b[2]*c[0]*c[1]*cy*x[1]*y[0] + 4*S[3]*b[2]*c[0]*c[1]*cy*x[1]*y[1] - 3*S[3]*b[2]*c[0]*c[1]*x[0]*y[0]*y[0] - 2*S[3]*b[2]*c[0]*c[1]*x[0]*y[0]*y[1] - S[3]*b[2]*c[0]*c[1]*x[0]*y[1]*y[1] - S[3]*b[2]*c[0]*c[1]*x[1]*y[0]*y[0] - 2*S[3]*b[2]*c[0]*c[1]*x[1]*y[0]*y[1] - 3*S[3]*b[2]*c[0]*c[1]*x[1]*y[1]*y[1])/(96*(delta*delta))
    ,
    ...
    ,
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(-12*F[0]*a[0]*a[1]*b[2] - 6*F[0]*a[0]*b[1]*b[2]*x[0] - 6*F[0]*a[0]*b[1]*b[2]*x[1] - 6*F[0]*a[0]*b[2]*c[1]*y[0] - 6*F[0]*a[0]*b[2]*c[1]*y[1] + 12*F[0]*a[1]*a[2]*b[0] + 6*F[0]*a[1]*b[0]*c[2]*y[0] + 6*F[0]*a[1]*b[0]*c[2]*y[1] - 6*F[0]*a[1]*b[2]*c[0]*y[0] - 6*F[0]*a[1]*b[2]*c[0]*y[1] + 6*F[0]*a[2]*b[0]*b[1]*x[0] + 6*F[0]*a[2]*b[0]*b[1]*x[1] + 6*F[0]*a[2]*b[0]*c[1]*y[0] + 6*F[0]*a[2]*b[0]*c[1]*y[1] + 4*F[0]*b[0]*b[1]*c[2]*x[0]*y[0] + 2*F[0]*b[0]*b[1]*c[2]*x[0]*y[1] + 2*F[0]*b[0]*b[1]*c[2]*x[1]*y[0] + 4*F[0]*b[0]*b[1]*c[2]*x[1]*y[1] + 4*F[0]*b[0]*c[1]*c[2]*y[0]*y[0] + 4*F[0]*b[0]*c[1]*c[2]*y[0]*y[1] + 4*F[0]*b[0]*c[1]*c[2]*y[1]*y[1] - 4*F[0]*b[1]*b[2]*c[0]*x[0]*y[0] - 2*F[0]*b[1]*b[2]*c[0]*x[0]*y[1] - 2*F[0]*b[1]*b[2]*c[0]*x[1]*y[0] - 4*F[0]*b[1]*b[2]*c[0]*x[1]*y[1] - 4*F[0]*b[2]*c[0]*c[1]*y[0]*y[0] - 4*F[0]*b[2]*c[0]*c[1]*y[0]*y[1] - 4*F[0]*b[2]*c[0]*c[1]*y[1]*y[1] - 12*F[1]*a[0]*a[1]*c[2] - 6*F[1]*a[0]*b[1]*c[2]*x[0] - 6*F[1]*a[0]*b[1]*c[2]*x[1] - 6*F[1]*a[0]*c[1]*c[2]*y[0] - 6*F[1]*a[0]*c[1]*c[2]*y[1] + 12*F[1]*a[1]*a[2]*c[0] - 6*F[1]*a[1]*b[0]*c[2]*x[0] - 6*F[1]*a[1]*b[0]*c[2]*x[1] + 6*F[1]*a[1]*b[2]*c[0]*x[0] + 6*F[1]*a[1]*b[2]*c[0]*x[1] + 6*F[1]*a[2]*b[1]*c[0]*x[0] + 6*F[1]*a[2]*b[1]*c[0]*x[1] + 6*F[1]*a[2]*c[0]*c[1]*y[0] + 6*F[1]*a[2]*c[0]*c[1]*y[1] - 4*F[1]*b[0]*b[1]*c[2]*x[0]*x[0] - 4*F[1]*b[0]*b[1]*c[2]*x[0]*x[1] - 4*F[1]*b[0]*b[1]*c[2]*x[1]*x[1] - 4*F[1]*b[0]*c[1]*c[2]*x[0]*y[0] - 2*F[1]*b[0]*c[1]*c[2]*x[0]*y[1] - 2*F[1]*b[0]*c[1]*c[2]*x[1]*y[0] - 4*F[1]*b[0]*c[1]*c[2]*x[1]*y[1] + 4*F[1]*b[1]*b[2]*c[0]*x[0]*x[0] + 4*F[1]*b[1]*b[2]*c[0]*x[0]*x[1] + 4*F[1]*b[1]*b[2]*c[0]*x[1]*x[1] + 4*F[1]*b[2]*c[0]*c[1]*x[0]*y[0] + 2*F[1]*b[2]*c[0]*c[1]*x[0]*y[1] + 2*F[1]*b[2]*c[0]*c[1]*x[1]*y[0] + 4*F[1]*b[2]*c[0]*c[1]*x[1]*y[1] + 12*S[0]*a[0]*a[1]*b[2]*cx - 6*S[0]*a[0]*a[1]*b[2]*x[0] - 6*S[0]*a[0]*a[1]*b[2]*x[1] + 6*S[0]*a[0]*b[1]*b[2]*cx*x[0] + 6*S[0]*a[0]*b[1]*b[2]*cx*x[1] - 4*S[0]*a[0]*b[1]*b[2]*x[0]*x[0] - 4*S[0]*a[0]*b[1]*b[2]*x[0]*x[1] - 4*S[0]*a[0]*b[1]*b[2]*x[1]*x[1] + 6*S[0]*a[0]*b[2]*c[1]*cx*y[0] + 6*S[0]*a[0]*b[2]*c[1]*cx*y[1] - 4*S[0]*a[0]*b[2]*c[1]*x[0]*y[0] - 2*S[0]*a[0]*b[2]*c[1]*x[0]*y[1] - 2*S[0]*a[0]*b[2]*c[1]*x[1]*y[0] - 4*S[0]*a[0]*b[2]*c[1]*x[1]*y[1] - 12*S[0]*a[1]*a[2]*b[0]*cx + 6*S[0]*a[1]*a[2]*b[0]*x[0] + 6*S[0]*a[1]*a[2]*b[0]*x[1] - 6*S[0]*a[1]*b[0]*c[2]*cx*y[0] - 6*S[0]*a[1]*b[0]*c[2]*cx*y[1] + 4*S[0]*a[1]*b[0]*c[2]*x[0]*y[0] + 2*S[0]*a[1]*b[0]*c[2]*x[0]*y[1] + 2*S[0]*a[1]*b[0]*c[2]*x[1]*y[0] + 4*S[0]*a[1]*b[0]*c[2]*x[1]*y[1] + 6*S[0]*a[1]*b[2]*c[0]*cx*y[0] + 6*S[0]*a[1]*b[2]*c[0]*cx*y[1] - 4*S[0]*a[1]*b[2]*c[0]*x[0]*y[0] - 2*S[0]*a[1]*b[2]*c[0]*x[0]*y[1] - 2*S[0]*a[1]*b[2]*c[0]*x[1]*y[0] - 4*S[0]*a[1]*b[2]*c[0]*x[1]*y[1] - 6*S[0]*a[2]*b[0]*b[1]*cx*x[0] - 6*S[0]*a[2]*b[0]*b[1]*cx*x[1] + 4*S[0]*a[2]*b[0]*b[1]*x[0]*x[0] + 4*S[0]*a[2]*b[0]*b[1]*x[0]*x[1] + 4*S[0]*a[2]*b[0]*b[1]*x[1]*x[1] - 6*S[0]*a[2]*b[0]*c[1]*cx*y[0] - 6*S[0]*a[2]*b[0]*c[1]*cx*y[1] + 4*S[0]*a[2]*b[0]*c[1]*x[0]*y[0] + 2*S[0]*a[2]*b[0]*c[1]*x[0]*y[1] + 2*S[0]*a[2]*b[0]*c[1]*x[1]*y[0] + 4*S[0]*a[2]*b[0]*c[1]*x[1]*y[1] - 4*S[0]*b[0]*b[1]*c[2]*cx*x[0]*y[0] - 2*S[0]*b[0]*b[1]*c[2]*cx*x[0]*y[1] - 2*S[0]*b[0]*b[1]*c[2]*cx*x[1]*y[0] - 4*S[0]*b[0]*b[1]*c[2]*cx*x[1]*y[1] + 3*S[0]*b[0]*b[1]*c[2]*x[0]*x[0]*y[0] + S[0]*b[0]*b[1]*c[2]*x[0]*x[0]*y[1] + 2*S[0]*b[0]*b[1]*c[2]*x[0]*x[1]*y[0] + 2*S[0]*b[0]*b[1]*c[2]*x[0]*x[1]*y[1] + S[0]*b[0]*b[1]*c[2]*x[1]*x[1]*y[0] + 3*S[0]*b[0]*b[1]*c[2]*x[1]*x[1]*y[1] - 4*S[0]*b[0]*c[1]*c[2]*cx*y[0]*y[0] - 4*S[0]*b[0]*c[1]*c[2]*cx*y[0]*y[1] - 4*S[0]*b[0]*c[1]*c[2]*cx*y[1]*y[1] + 3*S[0]*b[0]*c[1]*c[2]*x[0]*y[0]*y[0] + 2*S[0]*b[0]*c[1]*c[2]*x[0]*y[0]*y[1] + S[0]*b[0]*c[1]*c[2]*x[0]*y[1]*y[1] + S[0]*b[0]*c[1]*c[2]*x[1]*y[0]*y[0] + 2*S[0]*b[0]*c[1]*c[2]*x[1]*y[0]*y[1] + 3*S[0]*b[0]*c[1]*c[2]*x[1]*y[1]*y[1] + 4*S[0]*b[1]*b[2]*c[0]*cx*x[0]*y[0] + 2*S[0]*b[1]*b[2]*c[0]*cx*x[0]*y[1] + 2*S[0]*b[1]*b[2]*c[0]*cx*x[1]*y[0] + 4*S[0]*b[1]*b[2]*c[0]*cx*x[1]*y[1] - 3*S[0]*b[1]*b[2]*c[0]*x[0]*x[0]*y[0] - S[0]*b[1]*b[2]*c[0]*x[0]*x[0]*y[1] - 2*S[0]*b[1]*b[2]*c[0]*x[0]*x[1]*y[0] - 2*S[0]*b[1]*b[2]*c[0]*x[0]*x[1]*y[1] - S[0]*b[1]*b[2]*c[0]*x[1]*x[1]*y[0] - 3*S[0]*b[1]*b[2]*c[0]*x[1]*x[1]*y[1] + 4*S[0]*b[2]*c[0]*c[1]*cx*y[0]*y[0] + 4*S[0]*b[2]*c[0]*c[1]*cx*y[0]*y[1] + 4*S[0]*b[2]*c[0]*c[1]*cx*y[1]*y[1] - 3*S[0]*b[2]*c[0]*c[1]*x[0]*y[0]*y[0] - 2*S[0]*b[2]*c[0]*c[1]*x[0]*y[0]*y[1] - S[0]*b[2]*c[0]*c[1]*x[0]*y[1]*y[1] - S[0]*b[2]*c[0]*c[1]*x[1]*y[0]*y[0] - 2*S[0]*b[2]*c[0]*c[1]*x[1]*y[0]*y[1] - 3*S[0]*b[2]*c[0]*c[1]*x[1]*y[1]*y[1] + 12*S[1]*a[0]*a[1]*b[2]*cy - 6*S[1]*a[0]*a[1]*b[2]*y[0] - 6*S[1]*a[0]*a[1]*b[2]*y[1] + 6*S[1]*a[0]*b[1]*b[2]*cy*x[0] + 6*S[1]*a[0]*b[1]*b[2]*cy*x[1] - 4*S[1]*a[0]*b[1]*b[2]*x[0]*y[0] - 2*S[1]*a[0]*b[1]*b[2]*x[0]*y[1] - 2*S[1]*a[0]*b[1]*b[2]*x[1]*y[0] - 4*S[1]*a[0]*b[1]*b[2]*x[1]*y[1] + 6*S[1]*a[0]*b[2]*c[1]*cy*y[0] + 6*S[1]*a[0]*b[2]*c[1]*cy*y[1] - 4*S[1]*a[0]*b[2]*c[1]*y[0]*y[0] - 4*S[1]*a[0]*b[2]*c[1]*y[0]*y[1] - 4*S[1]*a[0]*b[2]*c[1]*y[1]*y[1] - 12*S[1]*a[1]*a[2]*b[0]*cy + 6*S[1]*a[1]*a[2]*b[0]*y[0] + 6*S[1]*a[1]*a[2]*b[0]*y[1] - 6*S[1]*a[1]*b[0]*c[2]*cy*y[0] - 6*S[1]*a[1]*b[0]*c[2]*cy*y[1] + 4*S[1]*a[1]*b[0]*c[2]*y[0]*y[0] + 4*S[1]*a[1]*b[0]*c[2]*y[0]*y[1] + 4*S[1]*a[1]*b[0]*c[2]*y[1]*y[1] + 6*S[1]*a[1]*b[2]*c[0]*cy*y[0] + 6*S[1]*a[1]*b[2]*c[0]*cy*y[1] - 4*S[1]*a[1]*b[2]*c[0]*y[0]*y[0] - 4*S[1]*a[1]*b[2]*c[0]*y[0]*y[1] - 4*S[1]*a[1]*b[2]*c[0]*y[1]*y[1] - 6*S[1]*a[2]*b[0]*b[1]*cy*x[0] - 6*S[1]*a[2]*b[0]*b[1]*cy*x[1] + 4*S[1]*a[2]*b[0]*b[1]*x[0]*y[0] + 2*S[1]*a[2]*b[0]*b[1]*x[0]*y[1] + 2*S[1]*a[2]*b[0]*b[1]*x[1]*y[0] + 4*S[1]*a[2]*b[0]*b[1]*x[1]*y[1] - 6*S[1]*a[2]*b[0]*c[1]*cy*y[0] - 6*S[1]*a[2]*b[0]*c[1]*cy*y[1] + 4*S[1]*a[2]*b[0]*c[1]*y[0]*y[0] + 4*S[1]*a[2]*b[0]*c[1]*y[0]*y[1] + 4*S[1]*a[2]*b[0]*c[1]*y[1]*y[1] - 4*S[1]*b[0]*b[1]*c[2]*cy*x[0]*y[0] - 2*S[1]*b[0]*b[1]*c[2]*cy*x[0]*y[1] - 2*S[1]*b[0]*b[1]*c[2]*cy*x[1]*y[0] - 4*S[1]*b[0]*b[1]*c[2]*cy*x[1]*y[1] + 3*S[1]*b[0]*b[1]*c[2]*x[0]*y[0]*y[0] + 2*S[1]*b[0]*b[1]*c[2]*x[0]*y[0]*y[1] + S[1]*b[0]*b[1]*c[2]*x[0]*y[1]*y[1] + S[1]*b[0]*b[1]*c[2]*x[1]*y[0]*y[0] + 2*S[1]*b[0]*b[1]*c[2]*x[1]*y[0]*y[1] + 3*S[1]*b[0]*b[1]*c[2]*x[1]*y[1]*y[1] - 4*S[1]*b[0]*c[1]*c[2]*cy*y[0]*y[0] - 4*S[1]*b[0]*c[1]*c[2]*cy*y[0]*y[1] - 4*S[1]*b[0]*c[1]*c[2]*cy*y[1]*y[1] + 3*S[1]*b[0]*c[1]*c[2]*y[0]*y[0]*y[0] + 3*S[1]*b[0]*c[1]*c[2]*y[0]*y[0]*y[1] + 3*S[1]*b[0]*c[1]*c[2]*y[0]*y[1]*y[1] + 3*S[1]*b[0]*c[1]*c[2]*y[1]*y[1]*y[1] + 4*S[1]*b[1]*b[2]*c[0]*cy*x[0]*y[0] + 2*S[1]*b[1]*b[2]*c[0]*cy*x[0]*y[1] + 2*S[1]*b[1]*b[2]*c[0]*cy*x[1]*y[0] + 4*S[1]*b[1]*b[2]*c[0]*cy*x[1]*y[1] - 3*S[1]*b[1]*b[2]*c[0]*x[0]*y[0]*y[0] - 2*S[1]*b[1]*b[2]*c[0]*x[0]*y[0]*y[1] - S[1]*b[1]*b[2]*c[0]*x[0]*y[1]*y[1] - S[1]*b[1]*b[2]*c[0]*x[1]*y[0]*y[0] - 2*S[1]*b[1]*b[2]*c[0]*x[1]*y[0]*y[1] - 3*S[1]*b[1]*b[2]*c[0]*x[1]*y[1]*y[1] + 4*S[1]*b[2]*c[0]*c[1]*cy*y[0]*y[0] + 4*S[1]*b[2]*c[0]*c[1]*cy*y[0]*y[1] + 4*S[1]*b[2]*c[0]*c[1]*cy*y[1]*y[1] - 3*S[1]*b[2]*c[0]*c[1]*y[0]*y[0]*y[0] - 3*S[1]*b[2]*c[0]*c[1]*y[0]*y[0]*y[1] - 3*S[1]*b[2]*c[0]*c[1]*y[0]*y[1]*y[1] - 3*S[1]*b[2]*c[0]*c[1]*y[1]*y[1]*y[1] + 12*S[2]*a[0]*a[1]*c[2]*cx - 6*S[2]*a[0]*a[1]*c[2]*x[0] - 6*S[2]*a[0]*a[1]*c[2]*x[1] + 6*S[2]*a[0]*b[1]*c[2]*cx*x[0] + 6*S[2]*a[0]*b[1]*c[2]*cx*x[1] - 4*S[2]*a[0]*b[1]*c[2]*x[0]*x[0] - 4*S[2]*a[0]*b[1]*c[2]*x[0]*x[1] - 4*S[2]*a[0]*b[1]*c[2]*x[1]*x[1] + 6*S[2]*a[0]*c[1]*c[2]*cx*y[0] + 6*S[2]*a[0]*c[1]*c[2]*cx*y[1] - 4*S[2]*a[0]*c[1]*c[2]*x[0]*y[0] - 2*S[2]*a[0]*c[1]*c[2]*x[0]*y[1] - 2*S[2]*a[0]*c[1]*c[2]*x[1]*y[0] - 4*S[2]*a[0]*c[1]*c[2]*x[1]*y[1] - 12*S[2]*a[1]*a[2]*c[0]*cx + 6*S[2]*a[1]*a[2]*c[0]*x[0] + 6*S[2]*a[1]*a[2]*c[0]*x[1] + 6*S[2]*a[1]*b[0]*c[2]*cx*x[0] + 6*S[2]*a[1]*b[0]*c[2]*cx*x[1] - 4*S[2]*a[1]*b[0]*c[2]*x[0]*x[0] - 4*S[2]*a[1]*b[0]*c[2]*x[0]*x[1] - 4*S[2]*a[1]*b[0]*c[2]*x[1]*x[1] - 6*S[2]*a[1]*b[2]*c[0]*cx*x[0] - 6*S[2]*a[1]*b[2]*c[0]*cx*x[1] + 4*S[2]*a[1]*b[2]*c[0]*x[0]*x[0] + 4*S[2]*a[1]*b[2]*c[0]*x[0]*x[1] + 4*S[2]*a[1]*b[2]*c[0]*x[1]*x[1] - 6*S[2]*a[2]*b[1]*c[0]*cx*x[0] - 6*S[2]*a[2]*b[1]*c[0]*cx*x[1] + 4*S[2]*a[2]*b[1]*c[0]*x[0]*x[0] + 4*S[2]*a[2]*b[1]*c[0]*x[0]*x[1] + 4*S[2]*a[2]*b[1]*c[0]*x[1]*x[1] - 6*S[2]*a[2]*c[0]*c[1]*cx*y[0] - 6*S[2]*a[2]*c[0]*c[1]*cx*y[1] + 4*S[2]*a[2]*c[0]*c[1]*x[0]*y[0] + 2*S[2]*a[2]*c[0]*c[1]*x[0]*y[1] + 2*S[2]*a[2]*c[0]*c[1]*x[1]*y[0] + 4*S[2]*a[2]*c[0]*c[1]*x[1]*y[1] + 4*S[2]*b[0]*b[1]*c[2]*cx*x[0]*x[0] + 4*S[2]*b[0]*b[1]*c[2]*cx*x[0]*x[1] + 4*S[2]*b[0]*b[1]*c[2]*cx*x[1]*x[1] - 3*S[2]*b[0]*b[1]*c[2]*x[0]*x[0]*x[0] - 3*S[2]*b[0]*b[1]*c[2]*x[0]*x[0]*x[1] - 3*S[2]*b[0]*b[1]*c[2]*x[0]*x[1]*x[1] - 3*S[2]*b[0]*b[1]*c[2]*x[1]*x[1]*x[1] + 4*S[2]*b[0]*c[1]*c[2]*cx*x[0]*y[0] + 2*S[2]*b[0]*c[1]*c[2]*cx*x[0]*y[1] + 2*S[2]*b[0]*c[1]*c[2]*cx*x[1]*y[0] + 4*S[2]*b[0]*c[1]*c[2]*cx*x[1]*y[1] - 3*S[2]*b[0]*c[1]*c[2]*x[0]*x[0]*y[0] - S[2]*b[0]*c[1]*c[2]*x[0]*x[0]*y[1] - 2*S[2]*b[0]*c[1]*c[2]*x[0]*x[1]*y[0] - 2*S[2]*b[0]*c[1]*c[2]*x[0]*x[1]*y[1] - S[2]*b[0]*c[1]*c[2]*x[1]*x[1]*y[0] - 3*S[2]*b[0]*c[1]*c[2]*x[1]*x[1]*y[1] - 4*S[2]*b[1]*b[2]*c[0]*cx*x[0]*x[0] - 4*S[2]*b[1]*b[2]*c[0]*cx*x[0]*x[1] - 4*S[2]*b[1]*b[2]*c[0]*cx*x[1]*x[1] + 3*S[2]*b[1]*b[2]*c[0]*x[0]*x[0]*x[0] + 3*S[2]*b[1]*b[2]*c[0]*x[0]*x[0]*x[1] + 3*S[2]*b[1]*b[2]*c[0]*x[0]*x[1]*x[1] + 3*S[2]*b[1]*b[2]*c[0]*x[1]*x[1]*x[1] - 4*S[2]*b[2]*c[0]*c[1]*cx*x[0]*y[0] - 2*S[2]*b[2]*c[0]*c[1]*cx*x[0]*y[1] - 2*S[2]*b[2]*c[0]*c[1]*cx*x[1]*y[0] - 4*S[2]*b[2]*c[0]*c[1]*cx*x[1]*y[1] + 3*S[2]*b[2]*c[0]*c[1]*x[0]*x[0]*y[0] + S[2]*b[2]*c[0]*c[1]*x[0]*x[0]*y[1] + 2*S[2]*b[2]*c[0]*c[1]*x[0]*x[1]*y[0] + 2*S[2]*b[2]*c[0]*c[1]*x[0]*x[1]*y[1] + S[2]*b[2]*c[0]*c[1]*x[1]*x[1]*y[0] + 3*S[2]*b[2]*c[0]*c[1]*x[1]*x[1]*y[1] + 12*S[3]*a[0]*a[1]*c[2]*cy - 6*S[3]*a[0]*a[1]*c[2]*y[0] - 6*S[3]*a[0]*a[1]*c[2]*y[1] + 6*S[3]*a[0]*b[1]*c[2]*cy*x[0] + 6*S[3]*a[0]*b[1]*c[2]*cy*x[1] - 4*S[3]*a[0]*b[1]*c[2]*x[0]*y[0] - 2*S[3]*a[0]*b[1]*c[2]*x[0]*y[1] - 2*S[3]*a[0]*b[1]*c[2]*x[1]*y[0] - 4*S[3]*a[0]*b[1]*c[2]*x[1]*y[1] + 6*S[3]*a[0]*c[1]*c[2]*cy*y[0] + 6*S[3]*a[0]*c[1]*c[2]*cy*y[1] - 4*S[3]*a[0]*c[1]*c[2]*y[0]*y[0] - 4*S[3]*a[0]*c[1]*c[2]*y[0]*y[1] - 4*S[3]*a[0]*c[1]*c[2]*y[1]*y[1] - 12*S[3]*a[1]*a[2]*c[0]*cy + 6*S[3]*a[1]*a[2]*c[0]*y[0] + 6*S[3]*a[1]*a[2]*c[0]*y[1] + 6*S[3]*a[1]*b[0]*c[2]*cy*x[0] + 6*S[3]*a[1]*b[0]*c[2]*cy*x[1] - 4*S[3]*a[1]*b[0]*c[2]*x[0]*y[0] - 2*S[3]*a[1]*b[0]*c[2]*x[0]*y[1] - 2*S[3]*a[1]*b[0]*c[2]*x[1]*y[0] - 4*S[3]*a[1]*b[0]*c[2]*x[1]*y[1] - 6*S[3]*a[1]*b[2]*c[0]*cy*x[0] - 6*S[3]*a[1]*b[2]*c[0]*cy*x[1] + 4*S[3]*a[1]*b[2]*c[0]*x[0]*y[0] + 2*S[3]*a[1]*b[2]*c[0]*x[0]*y[1] + 2*S[3]*a[1]*b[2]*c[0]*x[1]*y[0] + 4*S[3]*a[1]*b[2]*c[0]*x[1]*y[1] - 6*S[3]*a[2]*b[1]*c[0]*cy*x[0] - 6*S[3]*a[2]*b[1]*c[0]*cy*x[1] + 4*S[3]*a[2]*b[1]*c[0]*x[0]*y[0] + 2*S[3]*a[2]*b[1]*c[0]*x[0]*y[1] + 2*S[3]*a[2]*b[1]*c[0]*x[1]*y[0] + 4*S[3]*a[2]*b[1]*c[0]*x[1]*y[1] - 6*S[3]*a[2]*c[0]*c[1]*cy*y[0] - 6*S[3]*a[2]*c[0]*c[1]*cy*y[1] + 4*S[3]*a[2]*c[0]*c[1]*y[0]*y[0] + 4*S[3]*a[2]*c[0]*c[1]*y[0]*y[1] + 4*S[3]*a[2]*c[0]*c[1]*y[1]*y[1] + 4*S[3]*b[0]*b[1]*c[2]*cy*x[0]*x[0] + 4*S[3]*b[0]*b[1]*c[2]*cy*x[0]*x[1] + 4*S[3]*b[0]*b[1]*c[2]*cy*x[1]*x[1] - 3*S[3]*b[0]*b[1]*c[2]*x[0]*x[0]*y[0] - S[3]*b[0]*b[1]*c[2]*x[0]*x[0]*y[1] - 2*S[3]*b[0]*b[1]*c[2]*x[0]*x[1]*y[0] - 2*S[3]*b[0]*b[1]*c[2]*x[0]*x[1]*y[1] - S[3]*b[0]*b[1]*c[2]*x[1]*x[1]*y[0] - 3*S[3]*b[0]*b[1]*c[2]*x[1]*x[1]*y[1] + 4*S[3]*b[0]*c[1]*c[2]*cy*x[0]*y[0] + 2*S[3]*b[0]*c[1]*c[2]*cy*x[0]*y[1] + 2*S[3]*b[0]*c[1]*c[2]*cy*x[1]*y[0] + 4*S[3]*b[0]*c[1]*c[2]*cy*x[1]*y[1] - 3*S[3]*b[0]*c[1]*c[2]*x[0]*y[0]*y[0] - 2*S[3]*b[0]*c[1]*c[2]*x[0]*y[0]*y[1] - S[3]*b[0]*c[1]*c[2]*x[0]*y[1]*y[1] - S[3]*b[0]*c[1]*c[2]*x[1]*y[0]*y[0] - 2*S[3]*b[0]*c[1]*c[2]*x[1]*y[0]*y[1] - 3*S[3]*b[0]*c[1]*c[2]*x[1]*y[1]*y[1] - 4*S[3]*b[1]*b[2]*c[0]*cy*x[0]*x[0] - 4*S[3]*b[1]*b[2]*c[0]*cy*x[0]*x[1] - 4*S[3]*b[1]*b[2]*c[0]*cy*x[1]*x[1] + 3*S[3]*b[1]*b[2]*c[0]*x[0]*x[0]*y[0] + S[3]*b[1]*b[2]*c[0]*x[0]*x[0]*y[1] + 2*S[3]*b[1]*b[2]*c[0]*x[0]*x[1]*y[0] + 2*S[3]*b[1]*b[2]*c[0]*x[0]*x[1]*y[1] + S[3]*b[1]*b[2]*c[0]*x[1]*x[1]*y[0] + 3*S[3]*b[1]*b[2]*c[0]*x[1]*x[1]*y[1] - 4*S[3]*b[2]*c[0]*c[1]*cy*x[0]*y[0] - 2*S[3]*b[2]*c[0]*c[1]*cy*x[0]*y[1] - 2*S[3]*b[2]*c[0]*c[1]*cy*x[1]*y[0] - 4*S[3]*b[2]*c[0]*c[1]*cy*x[1]*y[1] + 3*S[3]*b[2]*c[0]*c[1]*x[0]*y[0]*y[0] + 2*S[3]*b[2]*c[0]*c[1]*x[0]*y[0]*y[1] + S[3]*b[2]*c[0]*c[1]*x[0]*y[1]*y[1] + S[3]*b[2]*c[0]*c[1]*x[1]*y[0]*y[0] + 2*S[3]*b[2]*c[0]*c[1]*x[1]*y[0]*y[1] + 3*S[3]*b[2]*c[0]*c[1]*x[1]*y[1]*y[1])/(96*(delta*delta))
    ,
    ...
    ,
    t*std::sqrt(x[0]*x[0] - 2*x[0]*x[1] + x[1]*x[1] + y[0]*y[0] - 2*y[0]*y[1] + y[1]*y[1])*(12*F[0]*a[0]*a[2]*b[1] + 6*F[0]*a[0]*b[1]*b[2]*x[0] + 6*F[0]*a[0]*b[1]*b[2]*x[1] + 6*F[0]*a[0]*b[1]*c[2]*y[0] + 6*F[0]*a[0]*b[1]*c[2]*y[1] - 12*F[0]*a[1]*a[2]*b[0] - 6*F[0]*a[1]*b[0]*b[2]*x[0] - 6*F[0]*a[1]*b[0]*b[2]*x[1] - 6*F[0]*a[1]*b[0]*c[2]*y[0] - 6*F[0]*a[1]*b[0]*c[2]*y[1] - 6*F[0]*a[2]*b[0]*c[1]*y[0] - 6*F[0]*a[2]*b[0]*c[1]*y[1] + 6*F[0]*a[2]*b[1]*c[0]*y[0] + 6*F[0]*a[2]*b[1]*c[0]*y[1] - 4*F[0]*b[0]*b[2]*c[1]*x[0]*y[0] - 2*F[0]*b[0]*b[2]*c[1]*x[0]*y[1] - 2*F[0]*b[0]*b[2]*c[1]*x[1]*y[0] - 4*F[0]*b[0]*b[2]*c[1]*x[1]*y[1] - 4*F[0]*b[0]*c[1]*c[2]*y[0]*y[0] - 4*F[0]*b[0]*c[1]*c[2]*y[0]*y[1] - 4*F[0]*b[0]*c[1]*c[2]*y[1]*y[1] + 4*F[0]*b[1]*b[2]*c[0]*x[0]*y[0] + 2*F[0]*b[1]*b[2]*c[0]*x[0]*y[1] + 2*F[0]*b[1]*b[2]*c[0]*x[1]*y[0] + 4*F[0]*b[1]*b[2]*c[0]*x[1]*y[1] + 4*F[0]*b[1]*c[0]*c[2]*y[0]*y[0] + 4*F[0]*b[1]*c[0]*c[2]*y[0]*y[1] + 4*F[0]*b[1]*c[0]*c[2]*y[1]*y[1] + 12*F[1]*a[0]*a[2]*c[1] + 6*F[1]*a[0]*b[2]*c[1]*x[0] + 6*F[1]*a[0]*b[2]*c[1]*x[1] + 6*F[1]*a[0]*c[1]*c[2]*y[0] + 6*F[1]*a[0]*c[1]*c[2]*y[1] - 12*F[1]*a[1]*a[2]*c[0] - 6*F[1]*a[1]*b[2]*c[0]*x[0] - 6*F[1]*a[1]*b[2]*c[0]*x[1] - 6*F[1]*a[1]*c[0]*c[2]*y[0] - 6*F[1]*a[1]*c[0]*c[2]*y[1] + 6*F[1]*a[2]*b[0]*c[1]*x[0] + 6*F[1]*a[2]*b[0]*c[1]*x[1] - 6*F[1]*a[2]*b[1]*c[0]*x[0] - 6*F[1]*a[2]*b[1]*c[0]*x[1] + 4*F[1]*b[0]*b[2]*c[1]*x[0]*x[0] + 4*F[1]*b[0]*b[2]*c[1]*x[0]*x[1] + 4*F[1]*b[0]*b[2]*c[1]*x[1]*x[1] + 4*F[1]*b[0]*c[1]*c[2]*x[0]*y[0] + 2*F[1]*b[0]*c[1]*c[2]*x[0]*y[1] + 2*F[1]*b[0]*c[1]*c[2]*x[1]*y[0] + 4*F[1]*b[0]*c[1]*c[2]*x[1]*y[1] - 4*F[1]*b[1]*b[2]*c[0]*x[0]*x[0] - 4*F[1]*b[1]*b[2]*c[0]*x[0]*x[1] - 4*F[1]*b[1]*b[2]*c[0]*x[1]*x[1] - 4*F[1]*b[1]*c[0]*c[2]*x[0]*y[0] - 2*F[1]*b[1]*c[0]*c[2]*x[0]*y[1] - 2*F[1]*b[1]*c[0]*c[2]*x[1]*y[0] - 4*F[1]*b[1]*c[0]*c[2]*x[1]*y[1] - 12*S[0]*a[0]*a[2]*b[1]*cx + 6*S[0]*a[0]*a[2]*b[1]*x[0] + 6*S[0]*a[0]*a[2]*b[1]*x[1] - 6*S[0]*a[0]*b[1]*b[2]*cx*x[0] - 6*S[0]*a[0]*b[1]*b[2]*cx*x[1] + 4*S[0]*a[0]*b[1]*b[2]*x[0]*x[0] + 4*S[0]*a[0]*b[1]*b[2]*x[0]*x[1] + 4*S[0]*a[0]*b[1]*b[2]*x[1]*x[1] - 6*S[0]*a[0]*b[1]*c[2]*cx*y[0] - 6*S[0]*a[0]*b[1]*c[2]*cx*y[1] + 4*S[0]*a[0]*b[1]*c[2]*x[0]*y[0] + 2*S[0]*a[0]*b[1]*c[2]*x[0]*y[1] + 2*S[0]*a[0]*b[1]*c[2]*x[1]*y[0] + 4*S[0]*a[0]*b[1]*c[2]*x[1]*y[1] + 12*S[0]*a[1]*a[2]*b[0]*cx - 6*S[0]*a[1]*a[2]*b[0]*x[0] - 6*S[0]*a[1]*a[2]*b[0]*x[1] + 6*S[0]*a[1]*b[0]*b[2]*cx*x[0] + 6*S[0]*a[1]*b[0]*b[2]*cx*x[1] - 4*S[0]*a[1]*b[0]*b[2]*x[0]*x[0] - 4*S[0]*a[1]*b[0]*b[2]*x[0]*x[1] - 4*S[0]*a[1]*b[0]*b[2]*x[1]*x[1] + 6*S[0]*a[1]*b[0]*c[2]*cx*y[0] + 6*S[0]*a[1]*b[0]*c[2]*cx*y[1] - 4*S[0]*a[1]*b[0]*c[2]*x[0]*y[0] - 2*S[0]*a[1]*b[0]*c[2]*x[0]*y[1] - 2*S[0]*a[1]*b[0]*c[2]*x[1]*y[0] - 4*S[0]*a[1]*b[0]*c[2]*x[1]*y[1] + 6*S[0]*a[2]*b[0]*c[1]*cx*y[0] + 6*S[0]*a[2]*b[0]*c[1]*cx*y[1] - 4*S[0]*a[2]*b[0]*c[1]*x[0]*y[0] - 2*S[0]*a[2]*b[0]*c[1]*x[0]*y[1] - 2*S[0]*a[2]*b[0]*c[1]*x[1]*y[0] - 4*S[0]*a[2]*b[0]*c[1]*x[1]*y[1] - 6*S[0]*a[2]*b[1]*c[0]*cx*y[0] - 6*S[0]*a[2]*b[1]*c[0]*cx*y[1] + 4*S[0]*a[2]*b[1]*c[0]*x[0]*y[0] + 2*S[0]*a[2]*b[1]*c[0]*x[0]*y[1] + 2*S[0]*a[2]*b[1]*c[0]*x[1]*y[0] + 4*S[0]*a[2]*b[1]*c[0]*x[1]*y[1] + 4*S[0]*b[0]*b[2]*c[1]*cx*x[0]*y[0] + 2*S[0]*b[0]*b[2]*c[1]*cx*x[0]*y[1] + 2*S[0]*b[0]*b[2]*c[1]*cx*x[1]*y[0] + 4*S[0]*b[0]*b[2]*c[1]*cx*x[1]*y[1] - 3*S[0]*b[0]*b[2]*c[1]*x[0]*x[0]*y[0] - S[0]*b[0]*b[2]*c[1]*x[0]*x[0]*y[1] - 2*S[0]*b[0]*b[2]*c[1]*x[0]*x[1]*y[0] - 2*S[0]*b[0]*b[2]*c[1]*x[0]*x[1]*y[1] - S[0]*b[0]*b[2]*c[1]*x[1]*x[1]*y[0] - 3*S[0]*b[0]*b[2]*c[1]*x[1]*x[1]*y[1] + 4*S[0]*b[0]*c[1]*c[2]*cx*y[0]*y[0] + 4*S[0]*b[0]*c[1]*c[2]*cx*y[0]*y[1] + 4*S[0]*b[0]*c[1]*c[2]*cx*y[1]*y[1] - 3*S[0]*b[0]*c[1]*c[2]*x[0]*y[0]*y[0] - 2*S[0]*b[0]*c[1]*c[2]*x[0]*y[0]*y[1] - S[0]*b[0]*c[1]*c[2]*x[0]*y[1]*y[1] - S[0]*b[0]*c[1]*c[2]*x[1]*y[0]*y[0] - 2*S[0]*b[0]*c[1]*c[2]*x[1]*y[0]*y[1] - 3*S[0]*b[0]*c[1]*c[2]*x[1]*y[1]*y[1] - 4*S[0]*b[1]*b[2]*c[0]*cx*x[0]*y[0] - 2*S[0]*b[1]*b[2]*c[0]*cx*x[0]*y[1] - 2*S[0]*b[1]*b[2]*c[0]*cx*x[1]*y[0] - 4*S[0]*b[1]*b[2]*c[0]*cx*x[1]*y[1] + 3*S[0]*b[1]*b[2]*c[0]*x[0]*x[0]*y[0] + S[0]*b[1]*b[2]*c[0]*x[0]*x[0]*y[1] + 2*S[0]*b[1]*b[2]*c[0]*x[0]*x[1]*y[0] + 2*S[0]*b[1]*b[2]*c[0]*x[0]*x[1]*y[1] + S[0]*b[1]*b[2]*c[0]*x[1]*x[1]*y[0] + 3*S[0]*b[1]*b[2]*c[0]*x[1]*x[1]*y[1] - 4*S[0]*b[1]*c[0]*c[2]*cx*y[0]*y[0] - 4*S[0]*b[1]*c[0]*c[2]*cx*y[0]*y[1] - 4*S[0]*b[1]*c[0]*c[2]*cx*y[1]*y[1] + 3*S[0]*b[1]*c[0]*c[2]*x[0]*y[0]*y[0] + 2*S[0]*b[1]*c[0]*c[2]*x[0]*y[0]*y[1] + S[0]*b[1]*c[0]*c[2]*x[0]*y[1]*y[1] + S[0]*b[1]*c[0]*c[2]*x[1]*y[0]*y[0] + 2*S[0]*b[1]*c[0]*c[2]*x[1]*y[0]*y[1] + 3*S[0]*b[1]*c[0]*c[2]*x[1]*y[1]*y[1] - 12*S[1]*a[0]*a[2]*b[1]*cy + 6*S[1]*a[0]*a[2]*b[1]*y[0] + 6*S[1]*a[0]*a[2]*b[1]*y[1] - 6*S[1]*a[0]*b[1]*b[2]*cy*x[0] - 6*S[1]*a[0]*b[1]*b[2]*cy*x[1] + 4*S[1]*a[0]*b[1]*b[2]*x[0]*y[0] + 2*S[1]*a[0]*b[1]*b[2]*x[0]*y[1] + 2*S[1]*a[0]*b[1]*b[2]*x[1]*y[0] + 4*S[1]*a[0]*b[1]*b[2]*x[1]*y[1] - 6*S[1]*a[0]*b[1]*c[2]*cy*y[0] - 6*S[1]*a[0]*b[1]*c[2]*cy*y[1] + 4*S[1]*a[0]*b[1]*c[2]*y[0]*y[0] + 4*S[1]*a[0]*b[1]*c[2]*y[0]*y[1] + 4*S[1]*a[0]*b[1]*c[2]*y[1]*y[1] + 12*S[1]*a[1]*a[2]*b[0]*cy - 6*S[1]*a[1]*a[2]*b[0]*y[0] - 6*S[1]*a[1]*a[2]*b[0]*y[1] + 6*S[1]*a[1]*b[0]*b[2]*cy*x[0] + 6*S[1]*a[1]*b[0]*b[2]*cy*x[1] - 4*S[1]*a[1]*b[0]*b[2]*x[0]*y[0] - 2*S[1]*a[1]*b[0]*b[2]*x[0]*y[1] - 2*S[1]*a[1]*b[0]*b[2]*x[1]*y[0] - 4*S[1]*a[1]*b[0]*b[2]*x[1]*y[1] + 6*S[1]*a[1]*b[0]*c[2]*cy*y[0] + 6*S[1]*a[1]*b[0]*c[2]*cy*y[1] - 4*S[1]*a[1]*b[0]*c[2]*y[0]*y[0] - 4*S[1]*a[1]*b[0]*c[2]*y[0]*y[1] - 4*S[1]*a[1]*b[0]*c[2]*y[1]*y[1] + 6*S[1]*a[2]*b[0]*c[1]*cy*y[0] + 6*S[1]*a[2]*b[0]*c[1]*cy*y[1] - 4*S[1]*a[2]*b[0]*c[1]*y[0]*y[0] - 4*S[1]*a[2]*b[0]*c[1]*y[0]*y[1] - 4*S[1]*a[2]*b[0]*c[1]*y[1]*y[1] - 6*S[1]*a[2]*b[1]*c[0]*cy*y[0] - 6*S[1]*a[2]*b[1]*c[0]*cy*y[1] + 4*S[1]*a[2]*b[1]*c[0]*y[0]*y[0] + 4*S[1]*a[2]*b[1]*c[0]*y[0]*y[1] + 4*S[1]*a[2]*b[1]*c[0]*y[1]*y[1] + 4*S[1]*b[0]*b[2]*c[1]*cy*x[0]*y[0] + 2*S[1]*b[0]*b[2]*c[1]*cy*x[0]*y[1] + 2*S[1]*b[0]*b[2]*c[1]*cy*x[1]*y[0] + 4*S[1]*b[0]*b[2]*c[1]*cy*x[1]*y[1] - 3*S[1]*b[0]*b[2]*c[1]*x[0]*y[0]*y[0] - 2*S[1]*b[0]*b[2]*c[1]*x[0]*y[0]*y[1] - S[1]*b[0]*b[2]*c[1]*x[0]*y[1]*y[1] - S[1]*b[0]*b[2]*c[1]*x[1]*y[0]*y[0] - 2*S[1]*b[0]*b[2]*c[1]*x[1]*y[0]*y[1] - 3*S[1]*b[0]*b[2]*c[1]*x[1]*y[1]*y[1] + 4*S[1]*b[0]*c[1]*c[2]*cy*y[0]*y[0] + 4*S[1]*b[0]*c[1]*c[2]*cy*y[0]*y[1] + 4*S[1]*b[0]*c[1]*c[2]*cy*y[1]*y[1] - 3*S[1]*b[0]*c[1]*c[2]*y[0]*y[0]*y[0] - 3*S[1]*b[0]*c[1]*c[2]*y[0]*y[0]*y[1] - 3*S[1]*b[0]*c[1]*c[2]*y[0]*y[1]*y[1] - 3*S[1]*b[0]*c[1]*c[2]*y[1]*y[1]*y[1] - 4*S[1]*b[1]*b[2]*c[0]*cy*x[0]*y[0] - 2*S[1]*b[1]*b[2]*c[0]*cy*x[0]*y[1] - 2*S[1]*b[1]*b[2]*c[0]*cy*x[1]*y[0] - 4*S[1]*b[1]*b[2]*c[0]*cy*x[1]*y[1] + 3*S[1]*b[1]*b[2]*c[0]*x[0]*y[0]*y[0] + 2*S[1]*b[1]*b[2]*c[0]*x[0]*y[0]*y[1] + S[1]*b[1]*b[2]*c[0]*x[0]*y[1]*y[1] + S[1]*b[1]*b[2]*c[0]*x[1]*y[0]*y[0] + 2*S[1]*b[1]*b[2]*c[0]*x[1]*y[0]*y[1] + 3*S[1]*b[1]*b[2]*c[0]*x[1]*y[1]*y[1] - 4*S[1]*b[1]*c[0]*c[2]*cy*y[0]*y[0] - 4*S[1]*b[1]*c[0]*c[2]*cy*y[0]*y[1] - 4*S[1]*b[1]*c[0]*c[2]*cy*y[1]*y[1] + 3*S[1]*b[1]*c[0]*c[2]*y[0]*y[0]*y[0] + 3*S[1]*b[1]*c[0]*c[2]*y[0]*y[0]*y[1] + 3*S[1]*b[1]*c[0]*c[2]*y[0]*y[1]*y[1] + 3*S[1]*b[1]*c[0]*c[2]*y[1]*y[1]*y[1] - 12*S[2]*a[0]*a[2]*c[1]*cx + 6*S[2]*a[0]*a[2]*c[1]*x[0] + 6*S[2]*a[0]*a[2]*c[1]*x[1] - 6*S[2]*a[0]*b[2]*c[1]*cx*x[0] - 6*S[2]*a[0]*b[2]*c[1]*cx*x[1] + 4*S[2]*a[0]*b[2]*c[1]*x[0]*x[0] + 4*S[2]*a[0]*b[2]*c[1]*x[0]*x[1] + 4*S[2]*a[0]*b[2]*c[1]*x[1]*x[1] - 6*S[2]*a[0]*c[1]*c[2]*cx*y[0] - 6*S[2]*a[0]*c[1]*c[2]*cx*y[1] + 4*S[2]*a[0]*c[1]*c[2]*x[0]*y[0] + 2*S[2]*a[0]*c[1]*c[2]*x[0]*y[1] + 2*S[2]*a[0]*c[1]*c[2]*x[1]*y[0] + 4*S[2]*a[0]*c[1]*c[2]*x[1]*y[1] + 12*S[2]*a[1]*a[2]*c[0]*cx - 6*S[2]*a[1]*a[2]*c[0]*x[0] - 6*S[2]*a[1]*a[2]*c[0]*x[1] + 6*S[2]*a[1]*b[2]*c[0]*cx*x[0] + 6*S[2]*a[1]*b[2]*c[0]*cx*x[1] - 4*S[2]*a[1]*b[2]*c[0]*x[0]*x[0] - 4*S[2]*a[1]*b[2]*c[0]*x[0]*x[1] - 4*S[2]*a[1]*b[2]*c[0]*x[1]*x[1] + 6*S[2]*a[1]*c[0]*c[2]*cx*y[0] + 6*S[2]*a[1]*c[0]*c[2]*cx*y[1] - 4*S[2]*a[1]*c[0]*c[2]*x[0]*y[0] - 2*S[2]*a[1]*c[0]*c[2]*x[0]*y[1] - 2*S[2]*a[1]*c[0]*c[2]*x[1]*y[0] - 4*S[2]*a[1]*c[0]*c[2]*x[1]*y[1] - 6*S[2]*a[2]*b[0]*c[1]*cx*x[0] - 6*S[2]*a[2]*b[0]*c[1]*cx*x[1] + 4*S[2]*a[2]*b[0]*c[1]*x[0]*x[0] + 4*S[2]*a[2]*b[0]*c[1]*x[0]*x[1] + 4*S[2]*a[2]*b[0]*c[1]*x[1]*x[1] + 6*S[2]*a[2]*b[1]*c[0]*cx*x[0] + 6*S[2]*a[2]*b[1]*c[0]*cx*x[1] - 4*S[2]*a[2]*b[1]*c[0]*x[0]*x[0] - 4*S[2]*a[2]*b[1]*c[0]*x[0]*x[1] - 4*S[2]*a[2]*b[1]*c[0]*x[1]*x[1] - 4*S[2]*b[0]*b[2]*c[1]*cx*x[0]*x[0] - 4*S[2]*b[0]*b[2]*c[1]*cx*x[0]*x[1] - 4*S[2]*b[0]*b[2]*c[1]*cx*x[1]*x[1] + 3*S[2]*b[0]*b[2]*c[1]*x[0]*x[0]*x[0] + 3*S[2]*b[0]*b[2]*c[1]*x[0]*x[0]*x[1] + 3*S[2]*b[0]*b[2]*c[1]*x[0]*x[1]*x[1] + 3*S[2]*b[0]*b[2]*c[1]*x[1]*x[1]*x[1] - 4*S[2]*b[0]*c[1]*c[2]*cx*x[0]*y[0] - 2*S[2]*b[0]*c[1]*c[2]*cx*x[0]*y[1] - 2*S[2]*b[0]*c[1]*c[2]*cx*x[1]*y[0] - 4*S[2]*b[0]*c[1]*c[2]*cx*x[1]*y[1] + 3*S[2]*b[0]*c[1]*c[2]*x[0]*x[0]*y[0] + S[2]*b[0]*c[1]*c[2]*x[0]*x[0]*y[1] + 2*S[2]*b[0]*c[1]*c[2]*x[0]*x[1]*y[0] + 2*S[2]*b[0]*c[1]*c[2]*x[0]*x[1]*y[1] + S[2]*b[0]*c[1]*c[2]*x[1]*x[1]*y[0] + 3*S[2]*b[0]*c[1]*c[2]*x[1]*x[1]*y[1] + 4*S[2]*b[1]*b[2]*c[0]*cx*x[0]*x[0] + 4*S[2]*b[1]*b[2]*c[0]*cx*x[0]*x[1] + 4*S[2]*b[1]*b[2]*c[0]*cx*x[1]*x[1] - 3*S[2]*b[1]*b[2]*c[0]*x[0]*x[0]*x[0] - 3*S[2]*b[1]*b[2]*c[0]*x[0]*x[0]*x[1] - 3*S[2]*b[1]*b[2]*c[0]*x[0]*x[1]*x[1] - 3*S[2]*b[1]*b[2]*c[0]*x[1]*x[1]*x[1] + 4*S[2]*b[1]*c[0]*c[2]*cx*x[0]*y[0] + 2*S[2]*b[1]*c[0]*c[2]*cx*x[0]*y[1] + 2*S[2]*b[1]*c[0]*c[2]*cx*x[1]*y[0] + 4*S[2]*b[1]*c[0]*c[2]*cx*x[1]*y[1] - 3*S[2]*b[1]*c[0]*c[2]*x[0]*x[0]*y[0] - S[2]*b[1]*c[0]*c[2]*x[0]*x[0]*y[1] - 2*S[2]*b[1]*c[0]*c[2]*x[0]*x[1]*y[0] - 2*S[2]*b[1]*c[0]*c[2]*x[0]*x[1]*y[1] - S[2]*b[1]*c[0]*c[2]*x[1]*x[1]*y[0] - 3*S[2]*b[1]*c[0]*c[2]*x[1]*x[1]*y[1] - 12*S[3]*a[0]*a[2]*c[1]*cy + 6*S[3]*a[0]*a[2]*c[1]*y[0] + 6*S[3]*a[0]*a[2]*c[1]*y[1] - 6*S[3]*a[0]*b[2]*c[1]*cy*x[0] - 6*S[3]*a[0]*b[2]*c[1]*cy*x[1] + 4*S[3]*a[0]*b[2]*c[1]*x[0]*y[0] + 2*S[3]*a[0]*b[2]*c[1]*x[0]*y[1] + 2*S[3]*a[0]*b[2]*c[1]*x[1]*y[0] + 4*S[3]*a[0]*b[2]*c[1]*x[1]*y[1] - 6*S[3]*a[0]*c[1]*c[2]*cy*y[0] - 6*S[3]*a[0]*c[1]*c[2]*cy*y[1] + 4*S[3]*a[0]*c[1]*c[2]*y[0]*y[0] + 4*S[3]*a[0]*c[1]*c[2]*y[0]*y[1] + 4*S[3]*a[0]*c[1]*c[2]*y[1]*y[1] + 12*S[3]*a[1]*a[2]*c[0]*cy - 6*S[3]*a[1]*a[2]*c[0]*y[0] - 6*S[3]*a[1]*a[2]*c[0]*y[1] + 6*S[3]*a[1]*b[2]*c[0]*cy*x[0] + 6*S[3]*a[1]*b[2]*c[0]*cy*x[1] - 4*S[3]*a[1]*b[2]*c[0]*x[0]*y[0] - 2*S[3]*a[1]*b[2]*c[0]*x[0]*y[1] - 2*S[3]*a[1]*b[2]*c[0]*x[1]*y[0] - 4*S[3]*a[1]*b[2]*c[0]*x[1]*y[1] + 6*S[3]*a[1]*c[0]*c[2]*cy*y[0] + 6*S[3]*a[1]*c[0]*c[2]*cy*y[1] - 4*S[3]*a[1]*c[0]*c[2]*y[0]*y[0] - 4*S[3]*a[1]*c[0]*c[2]*y[0]*y[1] - 4*S[3]*a[1]*c[0]*c[2]*y[1]*y[1] - 6*S[3]*a[2]*b[0]*c[1]*cy*x[0] - 6*S[3]*a[2]*b[0]*c[1]*cy*x[1] + 4*S[3]*a[2]*b[0]*c[1]*x[0]*y[0] + 2*S[3]*a[2]*b[0]*c[1]*x[0]*y[1] + 2*S[3]*a[2]*b[0]*c[1]*x[1]*y[0] + 4*S[3]*a[2]*b[0]*c[1]*x[1]*y[1] + 6*S[3]*a[2]*b[1]*c[0]*cy*x[0] + 6*S[3]*a[2]*b[1]*c[0]*cy*x[1] - 4*S[3]*a[2]*b[1]*c[0]*x[0]*y[0] - 2*S[3]*a[2]*b[1]*c[0]*x[0]*y[1] - 2*S[3]*a[2]*b[1]*c[0]*x[1]*y[0] - 4*S[3]*a[2]*b[1]*c[0]*x[1]*y[1] - 4*S[3]*b[0]*b[2]*c[1]*cy*x[0]*x[0] - 4*S[3]*b[0]*b[2]*c[1]*cy*x[0]*x[1] - 4*S[3]*b[0]*b[2]*c[1]*cy*x[1]*x[1] + 3*S[3]*b[0]*b[2]*c[1]*x[0]*x[0]*y[0] + S[3]*b[0]*b[2]*c[1]*x[0]*x[0]*y[1] + 2*S[3]*b[0]*b[2]*c[1]*x[0]*x[1]*y[0] + 2*S[3]*b[0]*b[2]*c[1]*x[0]*x[1]*y[1] + S[3]*b[0]*b[2]*c[1]*x[1]*x[1]*y[0] + 3*S[3]*b[0]*b[2]*c[1]*x[1]*x[1]*y[1] - 4*S[3]*b[0]*c[1]*c[2]*cy*x[0]*y[0] - 2*S[3]*b[0]*c[1]*c[2]*cy*x[0]*y[1] - 2*S[3]*b[0]*c[1]*c[2]*cy*x[1]*y[0] - 4*S[3]*b[0]*c[1]*c[2]*cy*x[1]*y[1] + 3*S[3]*b[0]*c[1]*c[2]*x[0]*y[0]*y[0] + 2*S[3]*b[0]*c[1]*c[2]*x[0]*y[0]*y[1] + S[3]*b[0]*c[1]*c[2]*x[0]*y[1]*y[1] + S[3]*b[0]*c[1]*c[2]*x[1]*y[0]*y[0] + 2*S[3]*b[0]*c[1]*c[2]*x[1]*y[0]*y[1] + 3*S[3]*b[0]*c[1]*c[2]*x[1]*y[1]*y[1] + 4*S[3]*b[1]*b[2]*c[0]*cy*x[0]*x[0] + 4*S[3]*b[1]*b[2]*c[0]*cy*x[0]*x[1] + 4*S[3]*b[1]*b[2]*c[0]*cy*x[1]*x[1] - 3*S[3]*b[1]*b[2]*c[0]*x[0]*x[0]*y[0]- S[3]*b[1]*b[2]*c[0]*x[0]*x[0]*y[1] - 2*S[3]*b[1]*b[2]*c[0]*x[0]*x[1]*y[0] - 2*S[3]*b[1]*b[2]*c[0]*x[0]*x[1]*y[1] - S[3]*b[1]*b[2]*c[0]*x[1]*x[1]*y[0] - 3*S[3]*b[1]*b[2]*c[0]*x[1]*x[1]*y[1] + 4*S[3]*b[1]*c[0]*c[2]*cy*x[0]*y[0] + 2*S[3]*b[1]*c[0]*c[2]*cy*x[0]*y[1] + 2*S[3]*b[1]*c[0]*c[2]*cy*x[1]*y[0] + 4*S[3]*b[1]*c[0]*c[2]*cy*x[1]*y[1] - 3*S[3]*b[1]*c[0]*c[2]*x[0]*y[0]*y[0] - 2*S[3]*b[1]*c[0]*c[2]*x[0]*y[0]*y[1] - S[3]*b[1]*c[0]*c[2]*x[0]*y[1]*y[1] - S[3]*b[1]*c[0]*c[2]*x[1]*y[0]*y[0] - 2*S[3]*b[1]*c[0]*c[2]*x[1]*y[0]*y[1] - 3*S[3]*b[1]*c[0]*c[2]*x[1]*y[1]*y[1])/(96*(delta*delta))
    };
...
std::vector<double> GT9::get_uu(const MeshElement* const e2, const std::vector<gp_Pnt>& bounds, const gp_Dir n) const{
