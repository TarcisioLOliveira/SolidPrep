...
std::vector<double> TET4::get_Nf(const double t, const std::vector<gp_Pnt>& points) const{
    ...
    const double x[]{points[0].X(), points[1].X(), points[2].X()};
    const double y[]{points[0].Y(), points[1].Y(), points[2].Y()};
    const double z[]{points[0].Z(), points[1].Z(), points[2].Z()};
    
std::vector<double> Nf{
(2*a[0] + b[0]*x[1] + b[0]*x[2] + c[0]*y[1] + c[0]*y[2] + d[0]*z[1] + d[0]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
0
,
0
...
(2*a[0] + b[0]*x[1] + b[0]*x[2] + c[0]*y[1] + c[0]*y[2] + d[0]*z[1] + d[0]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
(2*a[1] + b[1]*x[1] + b[1]*x[2] + c[1]*y[1] + c[1]*y[2] + d[1]*z[1] + d[1]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
0
,
0
...
(2*a[1] + b[1]*x[1] + b[1]*x[2] + c[1]*y[1] + c[1]*y[2] + d[1]*z[1] + d[1]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
(2*a[2] + b[2]*x[1] + b[2]*x[2] + c[2]*y[1] + c[2]*y[2] + d[2]*z[1] + d[2]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
0
,
0
...
(2*a[2] + b[2]*x[1] + b[2]*x[2] + c[2]*y[1] + c[2]*y[2] + d[2]*z[1] + d[2]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
(2*a[3] + b[3]*x[1] + b[3]*x[2] + c[3]*y[1] + c[3]*y[2] + d[3]*z[1] + d[3]*z[2])*std::sqrt(x[0]*x[0]*y[1]*y[1] - 2*x[0]*x[0]*y[1]*y[2] + x[0]*x[0]*y[2]*y[2] + x[0]*x[0]*z[1]*z[1] - 2*x[0]*x[0]*z[1]*z[2] + x[0]*x[0]*z[2]*z[2] - 2*x[0]*x[1]*y[0]*y[1] + 2*x[0]*x[1]*y[0]*y[2] + 2*x[0]*x[1]*y[1]*y[2] - 2*x[0]*x[1]*y[2]*y[2] - 2*x[0]*x[1]*z[0]*z[1] + 2*x[0]*x[1]*z[0]*z[2] + 2*x[0]*x[1]*z[1]*z[2] - 2*x[0]*x[1]*z[2]*z[2] + 2*x[0]*x[2]*y[0]*y[1] - 2*x[0]*x[2]*y[0]*y[2] - 2*x[0]*x[2]*y[1]*y[1] + 2*x[0]*x[2]*y[1]*y[2] + 2*x[0]*x[2]*z[0]*z[1] - 2*x[0]*x[2]*z[0]*z[2] - 2*x[0]*x[2]*z[1]*z[1] + 2*x[0]*x[2]*z[1]*z[2] + x[1]*x[1]*y[0]*y[0] - 2*x[1]*x[1]*y[0]*y[2] + x[1]*x[1]*y[2]*y[2] + x[1]*x[1]*z[0]*z[0] - 2*x[1]*x[1]*z[0]*z[2] + x[1]*x[1]*z[2]*z[2] - 2*x[1]*x[2]*y[0]*y[0] + 2*x[1]*x[2]*y[0]*y[1] + 2*x[1]*x[2]*y[0]*y[2] - 2*x[1]*x[2]*y[1]*y[2] - 2*x[1]*x[2]*z[0]*z[0] + 2*x[1]*x[2]*z[0]*z[1] + 2*x[1]*x[2]*z[0]*z[2] - 2*x[1]*x[2]*z[1]*z[2] + x[2]*x[2]*y[0]*y[0] - 2*x[2]*x[2]*y[0]*y[1] + x[2]*x[2]*y[1]*y[1] + x[2]*x[2]*z[0]*z[0] - 2*x[2]*x[2]*z[0]*z[1] + x[2]*x[2]*z[1]*z[1] + y[0]*y[0]*z[1]*z[1] - 2*y[0]*y[0]*z[1]*z[2] + y[0]*y[0]*z[2]*z[2] - 2*y[0]*y[1]*z[0]*z[1] + 2*y[0]*y[1]*z[0]*z[2] + 2*y[0]*y[1]*z[1]*z[2] - 2*y[0]*y[1]*z[2]*z[2] + 2*y[0]*y[2]*z[0]*z[1] - 2*y[0]*y[2]*z[0]*z[2] - 2*y[0]*y[2]*z[1]*z[1] + 2*y[0]*y[2]*z[1]*z[2] + y[1]*y[1]*z[0]*z[0] - 2*y[1]*y[1]*z[0]*z[2] + y[1]*y[1]*z[2]*z[2] - 2*y[1]*y[2]*z[0]*z[0] + 2*y[1]*y[2]*z[0]*z[1] + 2*y[1]*y[2]*z[0]*z[2] - 2*y[1]*y[2]*z[1]*z[2] + y[2]*y[2]*z[0]*z[0] - 2*y[2]*y[2]*z[0]*z[1] + y[2]*y[2]*z[1]*z[1])/(12*V)
,
0
,
0
