...
GlobalStressPnorm::GlobalStressPnorm(const projspec::DataMap& data):
...
const bool GlobalStressPnorm::reg = Factory<DensityBasedFunction>::add(
    [](const DataMap& data){
        return std::make_unique<GlobalStressPnorm>(data);
    },
    ObjectRequirements{
