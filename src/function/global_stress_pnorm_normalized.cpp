...
void GlobalStressPnormNormalized::initialize(){
    size_t x_size = 0;
...
double GlobalStressPnormNormalized::calculate(const std::vector<double>& u, const std::vector<double>& x){
    (void)x;
...
double GlobalStressPnormNormalized::calculate_with_gradient(const std::vector<double>& u, const std::vector<double>& x, std::vector<double>& grad){
