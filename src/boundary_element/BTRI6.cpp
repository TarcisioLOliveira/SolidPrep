...
math::Matrix BTRI6::get_dz_vector_matrix(const math::Matrix& S, const math::Matrix& D, const gp_Pnt& center) const{
    const size_t KW = this->K_DIM; // workaround that's necessary for some reason
    math::Matrix M(KW, 2);
...
math::Matrix BTRI6::get_dz_vector_matrix_1d(const math::Matrix& S, const math::Matrix& D, const math::Matrix& dS, const math::Matrix& dD, const gp_Pnt& center) const{
    const size_t KW = this->K_DIM; // workaround that's necessary for some reason
    math::Matrix M(KW, 2);
    const auto& gsi = utils::GaussLegendreTri<ORDER+1>::get();
...
math::Matrix BTRI6::get_force_vector_matrix(const math::Matrix& D, const gp_Pnt& center, const math::Matrix& rot) const{
...
math::Vector BTRI6::get_force_vector(const math::Matrix& D, const std::vector<double>& u, const gp_Pnt& center, const math::Matrix& rot, const bool transpose) const{
